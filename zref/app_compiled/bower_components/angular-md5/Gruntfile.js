...
module.exports = function (grunt) {
  ...
  require('time-grunt')(grunt); // Project configuration.
  ...
  grunt.registerTask('test', []); // Build task

  grunt.registerTask('build', ['clean', 'concat', 'ngmin:dist', 'uglify:buildSrc', 'uglify:buildDist']); // Default task
