...
firebase.storage.Reference.prototype.putString = function (data, format, metadata) {};
/**
...
firebase.storage.UploadTask.prototype.on = function (event, nextOrObserver, error, complete) {};
/**
