...
(function (window, angular) {
  ...
  angular.mock.$Browser.prototype = {
    ...
    url: function (url, replace, state) {
      ...
      if (url) {
        this.$$url = url; // Native pushState serializes & copies the object; simulate it.
    ...
    function createShortMethods(prefix) {
      angular.forEach(['GET', 'DELETE', 'JSONP', 'HEAD'], function (method) {
        $httpBackend[prefix + method] = function (url, headers, keys) {
          assertArgDefined(arguments, 0, 'url'); // Change url to `null` if `undefined` to stop it throwing an exception further down
  ...
  (function () {
    ...
    window.browserTrigger = function browserTrigger(element, eventType, eventData) {
      ...
      var originalPreventDefault = evnt.preventDefault,
          ...
          finalProcessDefault,
          angular = appWindow.angular || {}; // igor: temporary fix for https://bugzilla.mozilla.org/show_bug.cgi?id=684208
    ...
    function triggerForPath(element, evnt) {
      ...
      do {
        element.dispatchEvent(evnt); // eslint-disable-next-line no-unmodified-loop-condition
