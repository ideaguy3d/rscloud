...
(function () {
  ...
  var smoothScroll = function smoothScroll(element, options) {
    ...
    var getEasingPattern = function getEasingPattern(type, time) {
      switch (type) {
        case 'easeInQuad':
          return time * time;
    ...
    var getEndLocation = function getEndLocation(element) {
      var location = 0;
    ...
    return {
      ...
      link: function link($scope, $elem, $attrs) {
        if (typeof $attrs.scrollIf === 'undefined' || $attrs.scrollIf === 'true') {
          setTimeout(function () {
            var callbackBefore = function callbackBefore(element) {
            ...
            var callbackAfter = function callbackAfter(element) {
