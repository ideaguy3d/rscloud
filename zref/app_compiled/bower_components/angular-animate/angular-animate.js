...
(function (window, angular) {
  ...
  function ($animateProvider) {
    ...
    this.$get = ['$$rAF', '$rootScope', '$rootElement', '$document', '$$Map', '$$animation', '$$AnimateRunner', '$templateRequest', '$$jqLite', '$$forceReflow', '$$isDocumentHidden', function ($$rAF, $rootScope, $rootElement, $document, $$Map, $$animation, $$AnimateRunner, $templateRequest, $$jqLite, $$forceReflow, $$isDocumentHidden) {
      ...
      var callbackRegistry = Object.create(null); // remember that the `customFilter`/`classNameFilter` are set during the
      ...
      function queueAnimation(originalElement, event, initialOptions) {
        ...
        var documentHidden = $$isDocumentHidden(); // This is a hard disable of all animations the element itself, therefore  there is no need to
        ...
        $rootScope.$$postDigest(function () {
          ...
          var realRunner = $$animation(element, event, animationDetails.options); // this will update the runner's flow-control events based on
  ...
  function ($animateProvider) {
    ...
    this.$get = ['$$jqLite', '$rootScope', '$injector', '$$AnimateRunner', '$$Map', '$$rAFScheduler', function ($$jqLite, $rootScope, $injector, $$AnimateRunner, $$Map, $$rAFScheduler) {
      ...
      function sortAnimations(animations) {
        ...
        var i,
            lookup = new $$Map(); // this is done first beforehand so that the map
