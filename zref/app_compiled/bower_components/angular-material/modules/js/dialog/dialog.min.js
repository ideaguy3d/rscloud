...
!function (e, t, n) {
    ...
    return {
      ...
      link: function (i, a) {
        a.addClass("_md"), n(a), e(function () {
          ...
          var n,
              r = a[0].querySelector("md-dialog-content");
  ...
  function i(e) {
    ...
    function i(e, o, i, l, d, c, s, m, u, g, f, p, h) {
      function v(e) {
        e.defaultTheme = f.defaultTheme(), y(e);
      }

      function C(e, t, n, o) {
        if (o) {
          var i = o.htmlContent || n.htmlContent || "",
              a = o.textContent || n.textContent || o.content || n.content || "";
          if (i && !g.has("$sanitize")) throw Error("The ngSanitize module must be loaded in order to use htmlContent.");
          if (i && a) throw Error("md-dialog cannot have both `htmlContent` and `textContent`");
          o.mdHtmlContent = i, o.mdTextContent = a;
        }
      }
      ...
      function b(e, n, o, a) {
        ...
        function l() {
          ...
          if (o.focusOnOpen) {
            var t = i.findFocusTarget(n) || e() || d;
            t.focus();
          }
        }

        t.element(c[0].body).addClass("md-dialog-is-showing");
        var d = n.find("md-dialog");

        if (d.hasClass("ng-cloak")) {
          var s = "$mdDialog: using `<md-dialog ng-cloak>` will affect the dialog opening animations.";
          u.warn(s, n[0]);
        }

        return k(o), E(d, o), S(e, n, o), T(n, o), L(n, o).then(function () {
          x(n, o), r(), l();
        });
      }
      ...
      function y(e) {
        ...
        if (o) {
          ...
          i && (e.scope.theme = i);
          var a = o.registerChanges(function (t) {
      ...
      function k(e) {
          ...
          if (i && i.length) {
            var a = {
              ...
              width: 0
                ...
                r = t.isFunction(i[0].getBoundingClientRect);
            return t.extend(o || {}, {
              element: r ? i : n,
        ...
        e.origin = t.extend({
          ...
          bounds: null,
          focus: t.noop
        }, e.origin || {}), e.parent = i(e.parent, m), e.closeTo = o(i(e.closeTo)), e.openFrom = o(i(e.openFrom)), e.targetEvent && (e.origin = o(e.targetEvent.target, e.origin), e.originInteraction = h.getLastInteractionType());
      }
      ...
      function E(e, t) {
        var n = "alert" === t.$type ? "alertdialog" : "dialog",
            ...
            d = e.attr("id"),
            c = "dialogContent_" + (d || i.nextUid());
        e.attr({
          role: n,
          tabIndex: "-1"
        }), 0 === l.length && (l = e, d && (c = d)), l.attr("id", c), e.attr("aria-describedby", c), t.ariaLabel ? o.expect(e, "aria-label", t.ariaLabel) : o.expectAsync(e, "aria-label", function () {
      ...
      function x(e, t) {
        function n(e) {
          for (; e.parentNode;) {
            ...
            for (var t = e.parentNode.children, i = 0; i < t.length; i++) e === t[i] || A(t[i], ["SCRIPT", "STYLE"]) || t[i].setAttribute("aria-hidden", o);
      ...
      function L(e, t) {
        ...
        var n = e.find("md-dialog"),
          ...
          transitionOutClass: "md-transition-out"
            ...
            d = o.toTransformCss("");
        return n.toggleClass("md-dialog-fullscreen", !!t.fullscreen), o.translate3d(n, l, d, r).then(function (e) {
          return t.reverseAnimate = function () {
            ...
            }, l = d, d = o.toTransformCss(a(n, t.closeTo)), o.translate3d(n, l, d, r)) : e(d = o.toTransformCss(a(n, t.origin)));
      ...
      return {
        ...
        transformTemplate: function (e, t) {
          ...
          var o = p.startSymbol(),
              i = p.endSymbol(),
              a = o + (t.themeWatch ? "" : "::") + "theme" + i;
          return '<div class="md-dialog-container" tabindex="-1" md-theme="' + a + '">' + n(e) + "</div>";
        }
      };
    }
