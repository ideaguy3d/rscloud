...
!function (e, t, n) {
  ...
  function i(e, t, n, i) {
    function o(i, o, a) {
      function r() {
        a.mdSvgIcon || a.mdSvgSrc || (a.mdFontIcon && o.addClass("md-font " + a.mdFontIcon), o.addClass(c));
      }
      ...
      function u() {
        if (!a.mdSvgIcon && !a.mdSvgSrc) {
          ...
          c !== t && (o.removeClass(c), o.addClass(t), c = t);
        }
      }

      t(o);
      var I = a.mdFontIcon,
          c = e.fontSet(a.mdFontSet);
      r(), a.$observe("mdFontIcon", u), a.$observe("mdFontSet", u);
      var g = (o[0].getAttribute(a.$attr.mdSvgSrc), a.$normalize(a.$attr.mdSvgIcon || a.$attr.mdSvgSrc || ""));

      if (a.role || (n.expect(o, "role", "img"), a.role = "img"), "img" === a.role && !a.ariaHidden && !n.hasAriaLabel(o)) {
        var d;
        a.alt ? n.expect(o, "aria-label", a.alt) : n.parentHasAriaLabel(o, 2) ? n.expect(o, "aria-hidden", "true") : (d = a.mdFontIcon || a.mdSvgIcon || o.text()) ? n.expect(o, "aria-label", d) : n.expect(o, "aria-hidden", "true");
      }

      g && a.$observe(g, function (t) {
  ...
  function a(e, t) {
    this.url = e, this.viewBoxSize = t || u.defaultViewBoxSize;
  }

  function r(n, i, o, a, r, u) {
    function I(e) {
      if (e = e || "", t.isString(e) || (e = u.getTrustedUrl(e)), j[e]) return o.when(g(j[e]));
      if (v.test(e) || L.test(e)) return m(e).then(d(e));
    ...
    function g(e) {
      var n = e.clone(),
          i = "_cache" + r.nextUid();
      return n.id && (n.id += i), t.forEach(n.querySelectorAll("[id]"), function (e) {
        e.id += i;
      }), n;
    }
    ...
    function d(e) {
      return function (t) {
        return j[e] = S(t) ? t : new x(t, n[e]), j[e].clone();
      };
    }

    function s(e) {
      var t = n[e];
      return m(t.url).then(function (e) {
        return new x(e, t);
      });
    }
    ...
    function l(e) {
      function t(t) {
        var n = e.slice(e.lastIndexOf(":") + 1),
            o = t.querySelector("#" + n);
        return o ? new x(o, u) : i(e);
      }

      function i(e) {
        var t = "icon " + e + " not found";
        return a.warn(t), o.reject(t || e);
      }

      var r = e.substring(0, e.lastIndexOf(":")) || "$default",
          u = n[r];
      return u ? m(u.url).then(t) : i(e);
    }
        ...
        return o(function (n, o) {
          var r = function (e) {
            ...
            a.warn(n), o(e);
              ...
              u = function (i) {
            w[e] || (w[e] = t.element("<div>").append(i)[0].querySelector("svg")), n(w[e]);
          };
    ...
    var j = {},
        w = {},
        v = /[-\w@:%\+.~#?&\/\/=]{2,}\.[a-z]{2,4}\b(\/[-\w@:%\+.~#?&\/\/=]*)?/i,
        L = /^data:image\/svg\+xml[\s*;\w\-\=]*?(base64)?,(.*)$/i;
    return x.prototype = {
      clone: f,
      prepare: M
    }, I.fontSet = c, I;
  ...
  t.module("material.components.icon", ["material.core"]), t.module("material.components.icon").directive("mdIcon", ["$mdIcon", "$mdTheming", "$mdAria", "$sce", i]), r.$inject = ["config", "$templateRequest", "$q", "$log", "$mdUtil", "$sce"], t.module("material.components.icon").constant("$$mdSvgRegistry", {
  ...
  o.prototype = {
    icon: function (e, t, n) {
      return e.indexOf(":") == -1 && (e = "$default:" + e), u[e] = new a(t, n), this;
    },
    iconSet: function (e, t, n) {
      return u[e] = new a(t, n), this;
    },
    defaultIconSet: function (e, t) {
      var n = "$default";
      return u[n] || (u[n] = new a(e, t)), u[n].viewBoxSize = t || u.defaultViewBoxSize, this;
    },
    defaultViewBoxSize: function (e) {
      return u.defaultViewBoxSize = e, this;
    },
    fontSet: function (e, t) {
      return u.fontSets.push({
        alias: e,
        fontSet: t || e
      }), this;
    },
    defaultFontSet: function (e) {
      return u.defaultFontSet = e ? e : "", this;
    },
    defaultIconSize: function (e) {
      return u.defaultIconSize = e, this;
    },
    $get: ["$templateRequest", "$q", "$log", "$mdUtil", "$sce", function (e, t, n, i, o) {
      return r(u, e, t, n, i, o);
    }]
  };
