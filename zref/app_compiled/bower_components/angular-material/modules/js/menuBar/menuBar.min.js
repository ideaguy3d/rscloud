...
!function (e, t, n) {
  ...
  function o(e, n, o, r, i, s, a, u) {
    this.$element = o, this.$attrs = r, this.$mdConstant = i, this.$mdUtil = a, this.$document = s, this.$scope = e, this.$rootScope = n, this.$timeout = u;
    var d = this;
  ...
  function a(e, n, o) {
    return {
      ...
      compile: function (n, r) {
        ...
        function s(o) {
          ...
          t.forEach(r, function (e) {
            if (n[0].hasAttribute(e)) {
              ...
              d[0].setAttribute(e, t), n[0].removeAttribute(e);
            }
          });
        }
        ...
        var a = r.type,
            l = "md-in-menu-bar";
        if ("checkbox" != a && "radio" != a || !n.hasClass(l)) i("role", "menuitem", n[0].querySelector("md-button, button, a"));else {
          var u = n[0].textContent,
              d = t.element('<md-button type="button"></md-button>'),
              c = '<md-icon md-svg-src="' + o.mdChecked + '"></md-icon>';
          d.html(u), d.attr("tabindex", "0"), n.html(""), n.append(t.element(c)), n.append(d), n.addClass("md-indent").removeClass(l), i("role", "checkbox" == a ? "menuitemcheckbox" : "menuitemradio", d), s("ng-disabled");
        }
  ...
  t.module("material.components.menuBar", ["material.core", "material.components.icon", "material.components.menu"]), o.$inject = ["$scope", "$rootScope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"], t.module("material.components.menuBar").controller("MenuBarController", o);
  ...
  o.prototype.init = function () {
    ...
    e.on("keydown", this.handleKeyDown), this.parentToolbar = t.getClosest(e, "MD-TOOLBAR"), i.push(this.$rootScope.$on("$mdMenuOpen", function (t, n) {
      ...
      if (a.indexOf(i[0]) != -1 && (e[0].classList.remove("md-open"), i[0].classList.remove("md-open")), e[0].contains(i[0])) {
        for (var l = i[0]; l && a.indexOf(l) == -1;) l = t.getClosest(l, "MD-MENU", !0);
      ...
      for (r.disableOpenOnHover(); i.length;) i.shift()();
    ...
    switch (e.keyCode) {
      ...
      case n.LEFT_ARROW:
        s = this.focusMenu(-1), r && (a = t.element(s).controller("mdMenu"), this.scheduleOpenMenu(a)), i = !0;
        break;
    ...
    function e() {
      if ("radio" == a) {
        var e = s.ngValue ? i.$eval(s.ngValue) : s.value;
    ...
    var l = this.iconEl,
        ...
        d = this.handleClick;
    s.$observe("disabled", n), n(s.disabled), r.$render = function () {
