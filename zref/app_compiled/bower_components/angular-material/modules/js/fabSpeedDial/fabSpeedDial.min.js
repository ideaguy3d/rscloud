...
!function (n, e, t) {
  ...
  !function () {
      ...
      function g(n) {
        if (n.target) {
          var e = o.getClosest(n.target, "md-fab-trigger"),
              t = o.getClosest(n.target, "md-fab-actions");
          e || t || k.close();
        }
      }
      ...
      function o(t) {
        if (!t.hasClass("md-animations-waiting") || t.hasClass("_md-animations-ready")) {
          var i = t[0],
              ...
              s = parseInt(n.getComputedStyle(c).zIndex);
          e.forEach(a, function (n, e) {
            ...
            var t,
                ...
                s = (r.clientWidth - n.clientWidth) / 2;
    ...
    i.$inject = ["$timeout"], o.$inject = ["$timeout"];
    var a = 300;
    e.module("material.components.fabSpeedDial", ["material.core", "material.components.fabShared", "material.components.fabActions"]).directive("mdFabSpeedDial", t).animation(".md-fling", i).animation(".md-scale", o).service("mdFabSpeedDialFlingAnimation", i).service("mdFabSpeedDialScaleAnimation", o);
  }();
