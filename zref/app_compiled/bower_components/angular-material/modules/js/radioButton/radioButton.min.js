      ...
      if (r.count()) {
        var o = function (e) {
          return !t.element(e).attr("disabled");
            ...
            a = r[i < 0 ? "previous" : "next"](d, o) || r.first();
  ...
  function r(e, t, n) {
    function i(i, o, d, a) {
      ...
      function c() {
        ...
        e !== m && ("md-radio-group" !== o[0].parentNode.nodeName.toLowerCase() && o.parent().toggleClass(r, e), e && a.setActiveDescendant(o.attr("id")), m = e, o.attr("aria-checked", e).toggleClass(r, e));
      }

      function l(n, i) {
        n.attr({
          id: d.id || "radio_" + t.nextUid(),
          role: "radio",
          "aria-checked": "false"
      ...
      var m;
      n(o), l(o, i), d.ngValue ? t.nextTick(s, !1) : s();
    }
