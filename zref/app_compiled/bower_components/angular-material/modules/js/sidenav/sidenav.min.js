...
!function (e, n, t) {
  ...
  function o(e, o, r, i) {
    ...
    function d(n, r) {
      var s = e.get(n);
      return s || r ? s : (i.error(o.supplant(c, [n || ""])), t);
    }
    ...
    return function (e, t) {
      ...
      var o = t === !0,
          r = a.find(e, o);
      return !r && o ? a.waitFor(e) : !r && n.isUndefined(t) ? s(a, e) : r;
    };
  }
    ...
    function $(l, $, g, v) {
      ...
      function y(e) {
        var n = o.findFocusTarget($) || o.findFocusTarget($, "[md-sidenav-focus]") || $,
            t = $.parent();
        t[e ? "on" : "off"]("keydown", b), T && T[e ? "on" : "off"]("click", k);
        var r = C(t, e);
        return e && (q = p[0].activeElement, D = s.getLastInteractionType()), O(e), x = u.all([e && T ? d.enter(T, t) : T ? d.leave(T) : u.when(!0), d[e ? "removeClass" : "addClass"]($, "md-closed")]).then(function () {
          l.isOpen && (f(function () {
      ...
      g.mdDisableScrollTarget && (I = p[0].querySelector(g.mdDisableScrollTarget), I ? I = n.element(I) : a.warn(o.supplant('mdSidenav: couldn\'t find element matching selector "{selector}". Falling back to parent.', {
        selector: g.mdDisableScrollTarget
      }))), I || (I = $.parent()), g.hasOwnProperty("mdDisableBackdrop") || (T = o.createBackdrop(l, "md-sidenav-backdrop md-opaque ng-enter")), $.addClass("_md"), i($), T && i.inherit(T, $), $.on("$destroy", function () {
  ...
  function s(e, n, t, o, r) {
    ...
    var s = n.mdComponentId,
        ...
        l = d ? r(s)(e.$parent) : s;
    i.destroy = t.register(i, l), d && n.$observe("mdComponentId", function (e) {
