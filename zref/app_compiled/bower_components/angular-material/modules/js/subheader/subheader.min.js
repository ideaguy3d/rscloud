...
!function (e, t, i) {
  ...
  function n(e, i, n, d, r) {
    return {
      ...
      link: function (a, c, s, m, u) {
        function o(e) {
          return t.element(e[0].querySelector(".md-subheader-content"));
        }

        n(c), c.addClass("_md"), d.prefixer().removeAttribute(c, "ng-repeat");
        var l = c[0].outerHTML;
        s.$set("role", "heading"), r.expect(c, "aria-level", "2"), u(a, function (e) {
          o(c).append(e);
        }), c.hasClass("md-no-sticky") || u(a, function (t) {
          var n = i('<div class="md-subheader-wrapper" aria-hidden="true">' + l + "</div>")(a);
          d.nextTick(function () {
            o(n).append(t);
          }), e(a, c, n);
        });
