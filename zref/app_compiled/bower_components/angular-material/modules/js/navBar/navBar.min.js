...
!function (t, e, n) {
  ...
  function a(t, e, n, r) {
    this._$timeout = n, this._$scope = e, this._$mdConstant = r, this.mdSelectedNavItem, this.navBarAriaLabel, this._navBarEl = t[0], this._inkbar;
    ...
    return {
      ...
      template: function (t, e) {
        var n,
            ...
            s = e.mdNavSref,
            c = e.srefOpts;
        if ((o ? 1 : 0) + (i ? 1 : 0) + (s ? 1 : 0) > 1) throw Error("Must not specify more than one of the md-nav-click, md-nav-href, or md-nav-sref attributes per nav-item directive.");
      ...
      link: function (r, a, o, i) {
        n(function () {
          var n = i[0],
              o = i[1],
              s = e.element(a[0].querySelector("._md-nav-button"));
          n.name || (n.name = e.element(a[0].querySelector("._md-nav-button-text")).text().trim()), s.on("click", function () {
            o.mdSelectedNavItem = n.name, r.$apply();
          }), t.expectWithText(a, "aria-label");
        });
      }
    };
  }
  ...
  a.$inject = ["$element", "$scope", "$timeout", "$mdConstant"], o.$inject = ["$mdAria", "$$rAF"], i.$inject = ["$element"], r.$inject = ["$mdAria", "$mdTheming"], e.module("material.components.navBar", ["material.core"]).controller("MdNavBarController", a).directive("mdNavBar", r).controller("MdNavItemController", i).directive("mdNavItem", o), a.prototype._initTabs = function () {
    this._inkbar = e.element(this._navBarEl.querySelector("md-nav-ink-bar"));
    var t = this;
    ...
    if (r) {
      ...
      s && (s.setSelected(!1), a = r.indexOf(s)), i && (i.setSelected(!0), o = r.indexOf(i)), this._$timeout(function () {
        n._updateInkBarStyles(i, o, a);
      });
    }
  }, a.prototype._updateInkBarStyles = function (t, e, n) {
    if (this._inkbar.toggleClass("_md-left", e < n).toggleClass("_md-right", e > n), this._inkbar.css({
      display: e < 0 ? "none" : ""
    }), t) {
      var r = t.getButtonEl(),
          a = r.offsetLeft;
    ...
    if (r) {
      ...
      switch (t.keyCode) {
        case e.UP_ARROW:
        case e.LEFT_ARROW:
          a > 0 && this._moveFocus(r, n[a - 1]);
          break;

        case e.DOWN_ARROW:
        case e.RIGHT_ARROW:
          a < n.length - 1 && this._moveFocus(r, n[a + 1]);
          break;
