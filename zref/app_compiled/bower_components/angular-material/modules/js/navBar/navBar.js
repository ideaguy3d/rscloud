...
(function (window, angular, undefined) {
  ...
  function MdNavBarController($element, $scope, $timeout, $mdConstant) {
    ...
    this._$mdConstant = $mdConstant; // Data-bound variables.
    ...
    this.navBarAriaLabel; // State variables.
    ...
    this._inkbar;
    var self = this; // need to wait for transcluded content to be available
  ...
  MdNavBarController.prototype._updateTabs = function (newValue, oldValue) {
    ...
    var tabs = this._getTabs(); // this._getTabs can return null if nav-bar has not yet been initialized
  ...
  MdNavBarController.prototype.onKeydown = function (e) {
    ...
    var focusedTabIndex = tabs.indexOf(focusedTab); // use arrow keys to navigate between tabs
  ...
  function MdNavItem($mdAria, $$rAF) {
    return {
      ...
      template: function (tElement, tAttrs) {
        ...
        var buttonTemplate; // Cannot specify more than one nav attribute
  ...
  function MdNavItemController($element) {
    ...
    this._$element = $element; // Data-bound variables
