...
!function (e, t, n) {
  ...
  function r(e, r, o, i, a, l, s, u, d) {
    ...
    this.enableHoverListener = function () {
      ...
      t && t.stopPropagation(), t && t.preventDefault(), p.isOpen || (p.enableHoverListener(), p.isOpen = !0, a.nextTick(function () {
        p.onIsOpenChanged(p.isOpen);
      }), m = m || (t ? t.target : o[0]), m.setAttribute("aria-expanded", "true"), i.$emit("$mdMenuOpen", o), e.show({
        scope: i,
        mdMenuCtrl: p,
      ...
      var e = c[0].querySelector(f.buildSelector(["md-menu-focus-target", "md-autofocus"]));
      ...
      if (p.isOpen) {
        ...
        if (i.$emit("$mdMenuClose", o, l), e.hide(null, r), !n) {
          var s = p.restoreFocusTo || o.find("button")[0];
      ...
      open: this.open,
      close: this.close
    }, i.$mdOpenMenu = t.bind(this, function () {
      return d.warn("mdMenu: The $mdOpenMenu method is deprecated. Please use `$mdMenu.open`."), this.open.apply(this, arguments);
    });
  }
  ...
  function o(e) {
    function n(n) {
      ...
      var i = n.children()[0],
          a = n.children()[1],
          l = e.prefixer();
      l.hasAttribute(i, "ng-click") || (i = i.querySelector(l.buildSelector(["ng-click", "ng-mouseenter"])) || i);
      var s = "MD-BUTTON" === i.nodeName || "BUTTON" === i.nodeName;
      if (i && s && !i.hasAttribute("type") && i.setAttribute("type", "button"), !i) throw Error(o + "Expected the menu to have a trigger element.");
      if (!a || "MD-MENU-CONTENT" !== a.nodeName) throw Error(o + "Expected the menu to contain a `md-menu-content` element.");
      i && i.setAttribute("aria-haspopup", "true");
    ...
    function r(e, n, r, o) {
      var i = o[0],
          ...
          s = n.children()[1];
      n.addClass("_md"), s.hasAttribute("role") || s.setAttribute("role", "menu"), l.append(s), n.on("$destroy", function () {
        l.remove();
      }), n.append(l), l[0].style.display = "none", i.init(l, {
        isInMenuBar: a
      });
    }
  ...
  function i(e) {
    function r(e, r, a, l, s, u, d, c, m, f) {
      function p(n, r, o) {
      ...
      function h(e, t, n) {
        ...
        return n.cleanupInteraction(), n.cleanupBackdrop(), n.cleanupResizing(), n.hideBackdrop(), t.removeClass("md-clickable"), n.$destroy === !0 ? o() : r().then(o);
      }
      ...
      function g(n, o, i) {
        ...
        function g() {
          return i.backdrop ? (i.backdrop.on("click", b), function () {
            i.backdrop.off("click", b);
          }) : t.noop;
        }
        ...
        function M() {
          function r(t) {
            ...
            switch (t.keyCode) {
              ...
              case a.KEY_CODE.UP_ARROW:
                v(t, i.menuContentEl, i, -1) || i.nestLevel || i.mdMenuCtrl.triggerContainerProxy(t), n = !0;
                break;
          ...
          function o(t) {
            ...
            function o(e, t) {
              ...
              for (var n, r = 0; n = t[r]; ++r) if (C.hasAttribute(e, n)) return !0;
          ...
          if (!i.menuContentEl[0]) return t.noop;
          i.menuContentEl.on("keydown", r), i.menuContentEl[0].addEventListener("click", o, !0);
          var l = i.menuContentEl[0].querySelector(C.buildSelector(["md-menu-focus-target", "md-autofocus"]));
          if (!l) for (var s = i.menuContentEl[0].children.length, u = 0; u < s; u++) {
            var d = i.menuContentEl[0].children[u];
            if (l = d.querySelector(".md-button:not([disabled])")) break;

            if (d.firstElementChild && !d.firstElementChild.disabled) {
              l = d.firstElementChild;
              break;
            }
          }
          return l && l.focus(), function () {
            i.menuContentEl.off("keydown", r), i.menuContentEl[0].removeEventListener("click", o, !0);
          };
        }

        return m(i), i.menuContentEl[0] ? r.inherit(i.menuContentEl, i.target) : f.warn("$mdMenu: Menu elements should always contain a `md-menu-content` element,otherwise interactivity features will not work properly.", o), i.cleanupResizing = h(), i.hideBackdrop = p(n, o, i), l().then(function (e) {
          return i.alreadyOpen = !0, i.cleanupInteraction = M(), i.cleanupBackdrop = g(), o.addClass("md-clickable"), e;
        });
      }
      ...
      function y(t, r) {
        function o(e) {
          e.top = Math.max(Math.min(e.top, b.bottom - d.offsetHeight), b.top), e.left = Math.max(Math.min(e.left, b.right - d.offsetWidth), b.left);
        }
        ...
        var u,
            ...
            g = r.target[0].querySelector(C.buildSelector("md-menu-origin")) || r.target[0],
        ...
        "target" != E.top && "target" != E.left && "target-right" != E.left || (u = a(), u && (u = u.firstElementChild || u, u = u.querySelector(C.buildSelector("md-menu-align-target")) || u, M = u.getBoundingClientRect(), y = {
        ...
        switch (E.top) {
          case "target":
            k.top = y.top + v.top - M.top;
            break;

          case "cascade":
            k.top = v.top - parseFloat(h.paddingTop) - g.style.top;
            break;

          case "bottom":
            k.top = v.top + v.height;
            break;
        ...
        switch (E.left) {
          case "target":
            k.left = y.left + v.left - M.left, O += $ ? "right" : "left";
            break;

          case "target-left":
            k.left = v.left, O += "left";
            break;

          case "target-right":
            k.left = v.right - m.width + (m.right - M.right), O += "right";
            break;

          case "cascade":
            var w = $ ? v.left - m.width < b.left : v.right + m.width < b.right;
            k.left = w ? v.right - g.style.left : v.left - g.style.left - m.width, O += w ? "left" : "right";
            break;

          case "right":
            $ ? (k.left = v.right - v.width, O += "left") : (k.left = v.right - m.width, O += "right");
            break;

          case "left":
            $ ? (k.left = v.right - m.width, O += "right") : (k.left = v.left, O += "left");
            break;
        ...
        k.top += x.top, k.left += x.left, o(k);
        var A = Math.round(100 * Math.min(v.width / d.offsetWidth, 1)) / 100,
            S = Math.round(100 * Math.min(v.height / d.offsetHeight, 1)) / 100;
        return {
          top: Math.round(k.top),
          left: Math.round(k.left),
          transform: r.alreadyOpen ? n : e.supplant("scale({0},{1})", [A, S]),
          transformOrigin: O
        };
      }
    ...
    r.$inject = ["$mdUtil", "$mdTheming", "$mdConstant", "$document", "$window", "$q", "$$rAF", "$animateCss", "$animate", "$log"];
    var i = 8;
