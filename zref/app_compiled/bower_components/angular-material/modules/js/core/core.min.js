...
!function (e, t, n) {
  ...
  function r(e, t) {
    e.decorator("$$rAF", ["$delegate", d]), e.decorator("$q", ["$delegate", a]), t.theme("default").primaryPalette("indigo").accentPalette("pink").warnPalette("deep-orange").backgroundPalette("grey");
  }
  ...
  function d(e) {
    return e.throttle = function (t) {
      var n, o, r, d;
      return function () {
        n = arguments, d = this, r = t, o || (o = !0, e(function () {
          r.apply(d, Array.prototype.slice.call(n)), o = !1;
        }));
      };
    }, e;
  }
  ...
  function i() {
    function e(e) {
      var t = "#" === e[0] ? e.substr(1) : e,
          ...
          r = t.substr(n, n),
          d = t.substr(2 * n);
      return 1 === n && (o += o, r += r, d += d), "rgba(" + parseInt(o, 16) + "," + parseInt(r, 16) + "," + parseInt(d, 16) + ",0.1)";
    }
  ...
  function c() {
    function e(e) {
      var t = a + "-" + e,
          r = o(t),
          m = r.charAt(0).toLowerCase() + r.substring(1);
      return n(d, e) ? e : n(d, r) ? r : n(d, m) ? m : e;
    }
    ...
    var d = document.createElement("div"),
      ...
      CSS: {
        TRANSITIONEND: "transitionend" + (m ? " webkitTransitionEnd" : ""),
        ANIMATIONEND: "animationend" + (m ? " webkitAnimationEnd" : ""),
  ...
  function l(e, n) {
    ...
    function l(e, n) {
      return e ? (t.isNumber(n) || (n = M.length), M.splice(n, 0, e), u(e)) : -1;
    }
    ...
    function f(e, o, r, a) {
      ...
      for (var m = u(o);;) {
        ...
        var i = m + (e ? -1 : 1),
            c = null;
        if (d(i) ? c = M[i] : n && (c = e ? h() : E(), i = u(c)), null === c || i === a) return null;
        if (r(c)) return c;
  ...
  function s(e, n, o) {
    ...
    function a(e) {
      var t = p[e];
      return t || (t = p[e] = o.matchMedia(e)), t.addListener(m), E[t.media] = !!t.matches;
    }
    ...
    function l(n, o, r) {
      ...
      return n.forEach(function (n) {
        var a = s(o, n);
        t.isDefined(o[a]) && d.push(o.$observe(a, t.bind(void 0, r, null)));

        for (var m in e.MEDIA) a = s(o, n + "-" + m), t.isDefined(o[a]) && d.push(o.$observe(a, t.bind(void 0, r, m)));
      }), function () {
    ...
    var u = {},
        ...
        E = {},
        h = {};
    return r.getResponsiveAttribute = c, r.getQuery = i, r.watchResponsiveAttributes = l, r;
  }
  ...
  function u(e, n) {
    ...
    function d(e, t) {
      ...
      for (var n = o(t), r = 0; r < n.length; r++) if (e.hasAttribute(n[r])) return !0;

      return !1;
    }

    function a(e, t) {
      e = m(e), e && o(t).forEach(function (t) {
        e.removeAttribute(t);
      });
    }
  ...
  function p(o, r, d, a, m, i, c, l, s, u) {
    function p(e) {
    ...
    var b = i.startSymbol(),
      ...
      bidi: function (e, n, r, d) {
        var a = !("rtl" == o[0].dir || "rtl" == o[0].body.dir);
        if (0 == arguments.length) return a ? "ltr" : "rtl";
        var m = t.element(e);
        a && t.isDefined(r) ? m.css(n, p(r)) : !a && t.isDefined(d) && m.css(n, p(d));
      },
      bidiProperty: function (e, n, r, d) {
        var a = !("rtl" == o[0].dir || "rtl" == o[0].body.dir),
            m = t.element(e);
        a && t.isDefined(n) ? (m.css(n, p(d)), m.css(r, "")) : !a && t.isDefined(r) && (m.css(r, p(d)), m.css(n, ""));
      },
      clientRect: function (e, t, n) {
        var o = f(e);
        t = f(t || o.offsetParent || document.body);
        var r = o.getBoundingClientRect(),
            d = n ? t.getBoundingClientRect() : {
          left: 0,
          top: 0,
          width: 0,
          height: 0
      ...
      findFocusTarget: function (e, n) {
        ...
        var r,
            d = this.prefixer("md-autofocus", !0);
        return r = o(e, n || d), r || n == d || (r = o(e, this.prefixer("md-auto-focus", !0)), r || (r = o(e, d))), r;
      },
      disableScrollAround: function (e, n, r) {
        function d(e) {
          function n(e) {
            e.preventDefault();
          }
          ...
          e = t.element(e || m);
          var o;
          return r.disableScrollMask ? o = e : (o = t.element('<div class="md-scroll-mask">  <div class="md-scroll-mask-bar"></div></div>'), e.append(o)), o.on("wheel", n), o.on("touchmove", n), function () {
            o.off("wheel"), o.off("touchmove"), r.disableScrollMask || o[0].parentNode.removeChild(o[0]);
          };
        }
        ...
        function a() {
          ...
          return i && t.element(m).css({
            position: "fixed",
            width: "100%",
            top: -d + "px"
          }), m.clientWidth < a && (m.style.overflow = "hidden"), i && (e.style.overflowY = "scroll"), function () {
            m.style.cssText = r, e.style.cssText = n, m.scrollTop = d;
          };
        }

        if (r = r || {}, v.disableScrollAround._count = Math.max(0, v.disableScrollAround._count || 0), v.disableScrollAround._count++, v.disableScrollAround._restoreScroll) return v.disableScrollAround._restoreScroll;
        var m = o[0].body,
            i = a(),
            c = d(n);
        return v.disableScrollAround._restoreScroll = function () {
          --v.disableScrollAround._count <= 0 && (i(), c(), delete v.disableScrollAround._restoreScroll);
        };
      },
      ...
      createBackdrop: function (e, t) {
        return d(v.supplant('<md-backdrop class="{0}">', [t]))(e);
      },
      supplant: function (e, t, n) {
        return n = n || /\{([^\{\}]*)\}/g, e.replace(n, function (e, n) {
          ...
          try {
            for (var d in o) o.hasOwnProperty(d) && (r = r[o[d]]);
          } catch (a) {
            r = e;
          }
      ...
      valueOnUse: function (e, t, n) {
        var o = null,
            ...
            d = r.length > 3 ? r.slice(3) : [];
        Object.defineProperty(e, t, {
          get: function () {
            return null === o && (o = n.apply(e, d)), o;
          }
        });
      },
      nextUid: function () {
      ...
      elementContains: function (n, o) {
        var r = e.Node && e.Node.prototype && Node.prototype.contains,
            d = r ? t.bind(n, n.contains) : t.bind(n, function (e) {
      ...
      extractElementByName: function (e, n, o, r) {
        ...
        function m(e) {
          ...
          if (e) for (var n = 0, o = e.length; n < o; n++) {
            var r = e[n];
            if (!t) for (var a = 0, m = r.childNodes.length; a < m; a++) t = t || d([r.childNodes[a]]);
          }
          return t;
        }

        var i = d(e);
        return !i && r && c.warn(v.supplant("Unable to find node '{0}' in element '{1}'.", [n, e[0].outerHTML])), t.element(i || e);
      },
      initOptionalProperties: function (e, n, o) {
        o = o || {}, t.forEach(e.$$isolateBindings, function (r, d) {
          if (r.optional && t.isUndefined(e[d])) {
            var a = t.isDefined(n[r.attrName]);
            e[d] = t.isDefined(o[d]) ? o[d] : a;
          }
        });
      },
      nextTick: function (e, t, n) {
        ...
        return i.push({
          scope: n,
          callback: e
        }), null == t && (t = !0), d.digest = d.digest || t, d.queue = i, m || (d.timeout = r(o, 0, !1));
      },
      ...
      checkStickySupport: function () {
        ...
        for (var r = ["sticky", "-webkit-sticky"], d = 0; d < r.length; ++d) if (n.css({
          position: r[d],
          top: 0,
          "z-index": 2
        }), n.css("position") == r[d]) {
  ...
  function E() {
    ...
    return {
      disableWarnings: e,
      $get: ["$$rAF", "$log", "$window", "$interpolate", function (e, n, o, r) {
  ...
  function h(e, n, o, r) {
    function d(e, o, r) {
      ...
      !d || d.hasAttribute(o) && 0 !== d.getAttribute(o).length || l(d, o) || (r = t.isString(r) ? r.trim() : "", r.length ? e.attr(o, r) : p && n.warn('ARIA: Attribute "', o, '", required for accessibility, is missing on node:', d));
    }
    ...
    function c(e) {
      ...
      for (var n, o = document.createTreeWalker(e, NodeFilter.SHOW_TEXT, null, !1), r = ""; n = o.nextNode();) t(n) || (r += n.textContent);
    ...
    function l(e, t) {
      ...
      var r = e.hasChildNodes(),
          d = !1;
      if (r) for (var a = e.childNodes, m = 0; m < a.length; m++) {
        var i = a[m];
    ...
    function u(e, n) {
      ...
      return !!r.parentNode && (!!o(r.parentNode) || (n--, !!n && u(r.parentNode, n)));
    }
  ...
  function M(n, o, r) {
    ...
    return E.handler("press", {
      ...
      onSetup: function (e, t) {
        u && (this.oldTouchAction = e[0].style[u], e[0].style[u] = t.horizontal ? "pan-y" : "pan-x");
      },
      ...
      onMove: function (e, t) {
        var n, o;
        u || "touchmove" !== e.type || e.preventDefault(), this.state.dragPointer ? this.dispatchDragMove(e) : (this.state.options.horizontal ? (n = Math.abs(t.distanceX) > this.state.options.minDistance, o = Math.abs(t.distanceY) > this.state.options.minDistance * this.state.options.cancelMultiplier) : (n = Math.abs(t.distanceY) > this.state.options.minDistance, o = Math.abs(t.distanceX) > this.state.options.minDistance * this.state.options.cancelMultiplier), n ? (this.state.dragPointer = T(e), k(e, this.state.dragPointer), this.dispatchEvent(e, "$md.dragstart", this.state.dragPointer)) : o && this.cancel());
      },
      dispatchDragMove: o.throttle(function (e) {
        this.state.isRunning && (k(e, this.state.dragPointer), this.dispatchEvent(e, "$md.drag", this.state.dragPointer));
      }),
      onEnd: function (e, t) {
        this.state.dragPointer && (k(e, this.state.dragPointer), this.dispatchEvent(e, "$md.dragend", this.state.dragPointer));
      }
    }).handler("swipe", {
      options: {
        minVelocity: .65,
  ...
  function v(e, n) {
    ...
    function r(e) {
      ...
      t || e.$material || e.isIonicTap || N(e) || n ? (Y = null, "label" == e.target.tagName.toLowerCase() && (Y = {
        x: e.x,
        y: e.y
      })) : (e.preventDefault(), e.stopPropagation(), Y = null);
    }

    function d(e, t) {
      var o;

      for (var r in U) o = U[r], o instanceof n && ("start" === e && o.cancel(), o[e](t, P));
    }

    function a(e) {
      if (!P) {
        var t = +Date.now();
        j && !_(e, j) && t - j.endTime < 1500 || (P = T(e), d("start", e));
      }
    }

    function m(e) {
      P && _(e, P) && (k(e, P), d("move", e));
    }

    function i(e) {
      P && _(e, P) && (k(e, P), P.endTime = +Date.now(), d("end", e), j = P, P = null);
    }

    document.contains || (document.contains = function (e) {
      return document.body.contains(e);
    }), !q && e.isHijackingClicks && (document.addEventListener("click", r, !0), document.addEventListener("mouseup", o, !0), document.addEventListener("mousedown", o, !0), document.addEventListener("focus", o, !0), q = !0);
    var c = "mousedown touchstart pointerdown",
        l = "mousemove touchmove pointermove",
  ...
  function w() {
    function e(e) {
      ...
      function d(n, o) {
        ...
        return c = i.methods || [], l = a(i.optionsFactory, {}), t.forEach(m, function (e, t) {
          u[t] = e;
        }), t.forEach(i.presets, function (e, n) {
          function o(e) {
            this._options = t.extend({}, r, e);
          }

          var r = a(e.optionsFactory, {}),
              d = (e.methods || []).concat(c);
          ...
          if (t.extend(r, {
            ...
            var m = "show" + n.charAt(0).toUpperCase() + n.slice(1);
      ...
      d.$inject = ["$$interimElement", "$injector"];
    ...
    function o(e, o, r, d, a, m, i, c, l, s, u) {
      return function () {
        function p(e) {
          e = e || {};
          var t = new M(e || {}),
              n = e.multiple ? o.resolve() : o.all(v);
          e.multiple || (n = n.then(function () {
            var e = T.concat(_.map(g.cancel));
            return o.all(e);
          }));
          var r = n.then(function () {
            return t.show()["catch"](function (e) {
              ...
              v.splice(v.indexOf(r), 1), _.push(t);
            });
          });
          return v.push(r), t.deferred.promise["catch"](function (e) {
        ...
        function E(e, t) {
          function r(n) {
            ...
            return _.splice(_.indexOf(n), 1), T.push(o), n.deferred.promise;
          }

          return t = t || {}, t.closeAll ? o.all(_.slice().reverse().map(r)) : t.closeTo !== n ? o.all(_.slice(t.closeTo).map(r)) : r(_[_.length - 1]);
        }

        function h(e, n) {
          var r = _.pop();

          if (!r) return o.when(e);
          var d = r.remove(e, !0, n || {})["catch"](function (e) {
            return e;
          })["finally"](function () {
            T.splice(T.indexOf(d), 1);
          });
          return T.push(d), r.deferred.promise["catch"](t.noop);
        }

        function f(e) {
          return function () {
            var t = arguments;
            return _.length ? e.apply(g, t) : v.length ? v[0]["finally"](function () {
              return e.apply(g, t);
        ...
        function b(e) {
          var n = e ? null : _.shift(),
              r = t.element(e).length && t.element(e)[0].parentNode;
          ...
          if (r) {
            ...
            d.length && (n = d[0], _.splice(_.indexOf(n), 1));
          }

          return n ? n.remove(A, !1, {
            $destroy: !0
          }) : o.when(A);
        }
        ...
        function M(s) {
          function u() {
            return o(function (e, t) {
              ...
              s.onCompiling && s.onCompiling(s), h(s).then(function (t) {
                _ = f(t, s), s.cleanupElement = t.cleanup, N = A(_, s, t.controller).then(e, n);
              })["catch"](n);
            });
          }
          ...
          function p(e, n, r) {
            ...
            return _ ? (s = t.extend(s || {}, r || {}), s.cancelAutoHide && s.cancelAutoHide(), s.element.triggerHandler("$mdInterimElementRemove"), s.$destroy === !0 ? v(s.element, s).then(function () {
              n && a(e) || d(e);
            }) : (o.when(N)["finally"](function () {
              v(s.element, s).then(function () {
                n ? a(e) : d(e);
              }, a);
            }), T.deferred.promise)) : o.when(!1);
          }

          function E(e) {
            return e = e || {}, e.template && (e.template = i.processTemplate(e.template)), t.extend({
              preserveScope: !1,
              cancelAutoHide: t.noop,
              scope: e.scope || r.$new(e.isolateScope),
              onShow: function (e, t, n) {
                return m.enter(t, n.parent);
              },
              onRemove: function (e, t) {
                return t && m.leave(t) || o.when();
              }
            }, e);
          }
          ...
          function b(n, o) {
            ...
            if (r = t.isFunction(r) ? r(o.scope, n, o) : t.isString(r) ? t.element(e[0].querySelector(r)) : t.element(r), !(r || {}).length) {
              var d;
              return a[0] && a[0].querySelector && (d = a[0].querySelector(":not(svg) > body")), d || (d = a[0]), "#comment" == d.nodeName && (d = e[0].body), t.element(d);
            }
          ...
          function M() {
            var e,
                o = t.noop;
            s.hideDelay && (e = d(g.hide, s.hideDelay), o = function () {
              d.cancel(e);
            }), s.cancelAutoHide = function () {
              o(), s.cancelAutoHide = n;
            };
          }

          function A(e, n, r) {
            var d = n.onShowing || t.noop,
          ...
          function v(e, n) {
            ...
            return o(function (t, d) {
              try {
                ...
                r(e, a), n.$destroy ? (t(e), !n.preserveScope && n.scope && a.then(function () {
                  n.scope.$destroy();
                })) : a.then(function () {
  ...
  function x(e, o) {
    ...
    return d = {
      ...
      register: function (e, n) {
        ...
        return n ? (e.$$mdHandle = n, a.push(e), r(), o) : t.noop;
      },
      when: function (e) {
        if (r(e)) {
          var t = o.defer(),
              a = d.get(e);
          return a ? t.resolve(a) : (m[e] === n && (m[e] = []), m[e].push(t)), t.promise;
        }
  ...
  function S() {
    ...
    return {
      ...
      $get: ["$injector", function (e) {
        function o(o, r, d) {
          return n || r.controller("mdNoInk") ? t.noop : e.instantiate(D, {
            $scope: o,
            $element: r,
            rippleOptions: d
          });
  ...
  function I(n, o, r, d, a) {
    ...
    return m = {
      ...
      waitTransitionEnd: function (t, n) {
        var a = 3e3;
        return o(function (o, m) {
          function i(e) {
            e && e.target !== t[0] || (e && r.cancel(l), t.off(d.CSS.TRANSITIONEND, i), o());
          }
      ...
      calculateTransformValues: function (e, t) {
        ...
        if (o || r) {
          var d = o ? m.clientRect(o) || n() : m.copyRect(r),
              a = m.copyRect(e[0].getBoundingClientRect()),
              i = m.centerPointFor(a),
              c = m.centerPointFor(d);
          return {
            centerX: c.x - i.x,
            centerY: c.y - i.y,
      ...
      calculateZoomToOrigin: function (e, o) {
        var r = "translate3d( {centerX}px, {centerY}px, 0 ) scale( {scaleX}, {scaleY} )",
            d = t.bind(null, n.supplant, r);
        return d(m.calculateTransformValues(e, o));
      },
      ...
      toCss: function (e) {
        ...
        var o = {},
            r = "left top right bottom width height x y min-width min-height max-width max-height";
        return t.forEach(e, function (e, a) {
          if (!t.isUndefined(e)) if (r.indexOf(a) >= 0) o[a] = e + "px";else switch (a) {
            case "transition":
              n(a, d.CSS.TRANSITION, e);
              break;

            case "transform":
              n(a, d.CSS.TRANSFORM, e);
              break;

            case "transformOrigin":
              n(a, d.CSS.TRANSFORM_ORIGIN, e);
              break;
  ...
  o.$inject = ["$log", "$injector"], r.$inject = ["$provide", "$mdThemingProvider"], d.$inject = ["$delegate"], a.$inject = ["$delegate"], t.module("material.core", ["ngAnimate", "material.core.animate", "material.core.layout", "material.core.interaction", "material.core.gestures", "material.core.theming"]).config(r).run(o), m.$inject = ["$parse"], t.module("material.core").directive("mdAutofocus", m).directive("mdAutoFocus", m).directive("mdSidenavFocus", m), t.module("material.core").factory("$mdColorUtil", i), t.module("material.core").factory("$mdConstant", c), t.module("material.core").config(["$provide", function (e) {
    e.decorator("$mdUtil", ["$delegate", function (e) {
      return e.iterator = l, e;
    }]);
  }]), s.$inject = ["$mdConstant", "$rootScope", "$window"], t.module("material.core").factory("$mdMedia", s), t.module("material.core").config(["$provide", function (e) {
    e.decorator("$mdUtil", ["$delegate", function (e) {
      return e.prefixer = u, e;
    }]);
  }]), p.$inject = ["$document", "$timeout", "$compile", "$rootScope", "$$mdAnimate", "$interpolate", "$log", "$rootElement", "$window", "$$rAF"];
  var L = 0;
  t.module("material.core").factory("$mdUtil", p), t.element.prototype.focus = t.element.prototype.focus || function () {
    return this.length && this[0].focus(), this;
  }, t.element.prototype.blur = t.element.prototype.blur || function () {
    return this.length && this[0].blur(), this;
  }, h.$inject = ["$$rAF", "$log", "$window", "$interpolate"], t.module("material.core").provider("$mdAria", E), f.$inject = ["$q", "$templateRequest", "$injector", "$compile", "$controller"], t.module("material.core").service("$mdCompiler", f), f.prototype.compile = function (e) {
    return e.contentElement ? this._prepareContentElement(e) : this._compileTemplate(e);
  }, f.prototype._prepareContentElement = function (e) {
  ...
  }, f.prototype._compileTemplate = function (e) {
    var n = this,
        o = e.templateUrl,
        r = e.template || "",
        d = t.extend({}, e.resolve),
        a = t.extend({}, e.locals),
        m = e.transformTemplate || t.identity;
    return t.forEach(d, function (e, o) {
      t.isString(e) ? d[o] = n.$injector.get(e) : d[o] = n.$injector.invoke(e);
    }), t.extend(d, a), o ? d.$$ngTemplate = this.$templateRequest(o) : d.$$ngTemplate = this.$q.when(r), this.$q.all(d).then(function (o) {
      var r = m(o.$$ngTemplate, e),
          d = e.element || t.element("<div>").html(r.trim()).contents();
      return n._compileElement(o, d, e);
    });
  }, f.prototype._compileElement = function (e, n, o) {
    function r(r) {
      if (e.$scope = r, o.controller) {
        var i = t.extend(e, {
          $element: n
        }),
            c = d.$controller(o.controller, i, !0, o.controllerAs);
        o.bindToController && t.extend(c.instance, e);
        var l = c();
        n.data("$ngControllerController", l), n.children().data("$ngControllerController", l), m.controller = l;
      }
    ...
    return m;
  }, f.prototype._fetchContentElement = function (e) {
    function n(e) {
      var t = e.parentNode,
    ...
    var o = e.contentElement,
        r = null;
    return t.isString(o) ? (o = document.querySelector(o), r = n(o)) : (o = o[0] || o, r = document.contains(o) ? n(o) : function () {
  ...
  var P,
      ...
      Y = null,
      q = !1;
  t.module("material.core.gestures", []).provider("$mdGesture", b).factory("$$MdGestureHandler", A).run(v), b.prototype = {
  ...
  }, H.$inject = ["$timeout", "$mdUtil"], t.module("material.core.interaction", []).service("$mdInteraction", H), H.prototype.initializeEvents = function () {
  ...
  }, t.module("material.core").provider("$$interimElement", w), function () {
    function e(e) {
      function m(e) {
        return e.replace(s, "").replace(u, function (e, t, n, o) {
          return o ? n.toUpperCase() : n;
        });
      }
      ...
      var s = /^((?:x|data)[\:\-_])/i,
          ...
          h = ["show", "hide", "layout-padding", "layout-margin"];
    ...
    function r(e) {
      return ["$timeout", function (n) {
        return {
          ...
          priority: -10,
          compile: function (o) {
            return k.enabled ? (o.addClass(e), function (t, o) {
              n(function () {
                o.removeClass(e);
              }, 10, !1);
            }) : t.noop;
    ...
    function d(e) {
      function n(t, n, o) {
        var r = m(n, e, o),
            d = o.$observe(o.$normalize(e), r);
        r(p(e, o, "")), t.$on("$destroy", function () {
          d();
        });
      }

      return ["$mdUtil", "$interpolate", "$log", function (o, r, d) {
        return f = o, b = r, M = d, {
          restrict: "A",
          compile: function (o, r) {
            var d;
            return k.enabled && (c(e, r, o, M), l(e, p(e, r, ""), s(o, e, r)), d = n), d || t.noop;
          }
        };
      }];
    }
    ...
    function a(e) {
      ...
      return ["$mdUtil", "$interpolate", "$log", function (o, r, d) {
        return f = o, b = r, M = d, {
          ...
          compile: function (o, r) {
            var d;
            return k.enabled && (l(e, p(e, r, ""), s(o, e, r)), n(null, o), d = n), d || t.noop;
          }
        };
      }];
    }
    ...
    function m(e, n) {
      ...
      return function (r) {
        var d = l(n, r || "");
        t.isDefined(d) && (o && e.removeClass(o), o = d ? n + "-" + d.trim().replace(A, "-") : n, e.addClass(o));
      };
    }
    ...
    function c(e, t, n, o) {
      var r,
          d,
          a,
          m = n[0].nodeName.toLowerCase();

      switch (e.replace(g, "")) {
        case "flex":
          "md-button" != m && "fieldset" != m || (d = "<" + m + " " + e + "></" + m + ">", a = "https://github.com/philipwalton/flexbugs#9-some-html-elements-cant-be-flex-containers", r = "Markup '{0}' may not work as expected in IE Browsers. Consult '{1}' for details.", o.warn(f.supplant(r, [d, a])));
      }
    }
    ...
    function p(e, t, n) {
      var o = t.$normalize(e);
      return t[o] ? t[o].trim().replace(A, "-") : n || null;
    }

    function E(e, t, n) {
      e = n && e ? e.replace(A, n) : e;
      var o = !1;
      return e && t.forEach(function (t) {
        t = n ? t.replace(A, n) : t, o = o || t === e;
      }), o;
    }
    ...
    function h(e) {
      ...
      return e = e || "", 0 !== e.indexOf("-") && 0 !== e.indexOf(" ") || (e = "none" + e), t = e.toLowerCase().trim().replace(A, "-").split("-"), t.length && "space" === t[0] && (t = [t[0] + "-" + t[1], t[2]]), t.length > 0 && (n.main = t[0] || n.main), t.length > 1 && (n.cross = t[1] || n.cross), _.indexOf(n.main) < 0 && (n.main = "start"), N.indexOf(n.cross) < 0 && (n.cross = "stretch"), n;
    }
    ...
    var f,
        ...
        A = /\s+/g,
        v = ["grow", "initial", "auto", "none", "noshrink", "nogrow"],
        T = ["row", "column"],
        _ = ["", "start", "center", "end", "stretch", "space-around", "space-between"],
        N = ["", "start", "center", "end", "stretch"],
        k = {
      enabled: !0,
      breakpoints: []
    };
    e(t.module("material.core.layout", ["ng"]));
  }(), $.$inject = ["$timeout"], t.module("material.core").service("$mdLiveAnnouncer", $), $.prototype.announce = function (e, t) {
    t || (t = "polite");
    var n = this;
  ...
  }, $.prototype._createLiveElement = function () {
    ...
    function e(e) {
      ...
      return !!n && (d[e] = t.element(n), !0);
    }

    function n(n, o) {
      if (e(n), d[n]) d[n].attr("content", o);else {
        var a = t.element('<meta name="' + n + '" content="' + o + '"/>');
        r.append(a), d[n] = a;
      }
      return function () {
        d[n].attr("content", ""), d[n].remove(), delete d[n];
      };
    }

    function o(t) {
      if (!e(t)) throw Error("$$mdMeta: could not find a meta tag with the name '" + t + "'");
      return d[t].attr("content");
    }

    var r = t.element(document.head),
        d = {},
        a = {
      setMeta: n,
      getMeta: o
  ...
  }), x.$inject = ["$log", "$q"], t.module("material.core").factory("$mdComponentRegistry", x), function () {
    function e(e) {
      function n(e) {
      ...
      return {
        attach: function (o, r, d) {
          return d = t.extend(n(r), d), e.attach(o, r, d);
        }
      };
    }
  ...
  }(), D.$inject = ["$scope", "$element", "rippleOptions", "$window", "$timeout", "$mdUtil", "$mdColorUtil"], C.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], t.module("material.core").provider("$mdInkRipple", S).directive("mdInkRipple", C).directive("mdNoInk", O).directive("mdNoBar", O).directive("mdNoStretch", O);
  var W = 450;
  D.prototype.color = function (e) {
    function n() {
    ...
    return this.color();
  }, D.prototype._parseColor = function (e, t) {
    t = t || 1;
  ...
  }, D.prototype.handleMousedown = function (e) {
  ...
  }, D.prototype.createRipple = function (e, n) {
    function o(e, t, n) {
    ...
    if (this.isRippleAllowed()) {
      var r = this,
          ...
          m = this.$element.prop("clientWidth"),
          i = this.$element.prop("clientHeight"),
          c = 2 * Math.max(Math.abs(m - e), e),
          l = 2 * Math.max(Math.abs(i - n), n),
          s = o(this.options.fitRipple, c, l),
          u = this.calculateColor();
      a.css({
        left: e + "px",
        top: n + "px",
        background: "black",
      ...
      }, .35 * W, !1), this.options.dimBackground && this.container.css({
        backgroundColor: u
  ...
  }, D.prototype.fadeOutComplete = function (e) {
    ...
    function o(t, o) {
      ...
      function l(t) {
        function n(t) {
          if (t = 0 === arguments.length || !!t, t !== o.isDark) {
            o.isDark = t, o.foregroundPalette = o.isDark ? f : h, o.foregroundShadow = o.isDark ? b : M;
            var n = o.isDark ? k : N,
                r = o.isDark ? N : k;
        ...
        var o = this;
        o.name = t, o.colors = {}, o.dark = n, n(!1), T.forEach(function (t) {
          var n = (o.isDark ? k : N)[t];
          o[t + "Palette"] = function (r, d) {
            var a = o.colors[t] = {
              name: r,
              hues: e.extend({}, n, d)
            };
            return Object.keys(a.hues).forEach(function (e) {
              ...
              if (y.indexOf(e) == -1) throw new Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1", e).replace("%2", o.name).replace("%3", t).replace("%4", r).replace("%5", y.join(", ")));
            }), o;
          }, o[t + "Color"] = function () {
      ...
      function s(t, o, r, d) {
        ...
        function m(e, t) {
          function n() {
            return m && m.$mdTheme || ("default" == v ? "" : v);
          }

          function r(t) {
            if (t) {
              a(t) || d.warn("Attempted to use unregistered theme '" + t + "'. Register it with $mdThemingProvider.theme().");
              var n = e.data("$mdThemeName");
              n && e.removeClass("md-" + n + "-theme"), e.addClass("md-" + t + "-theme"), e.data("$mdThemeName", t), m && e.data("$mdThemeController", m);
            }
          }

          var m = t.controller("mdTheme") || e.data("$mdThemeController");
          if (r(n()), m) var i = A || m.$shouldWatch || o.parseAttributeBoolean(e.attr("md-theme-watch")),
              c = m.registerChanges(function (t) {
            r(t), i ? e.on("$destroy", c) : c();
          });
        }
        ...
        }), l.inherit = m, l.registered = a, l.defaultTheme = function () {
          return v;
        ...
        }, l.setBrowserColor = w, l;
      }

      s.$inject = ["$rootScope", "$mdUtil", "$q", "$log"], p = {};
      var E,
          g = {},
          A = !1,
          v = "default";
      ...
      var _ = function (e) {
        ...
        var n = t.theme || "default",
            o = t.hue || "800",
            r = p[t.palette] || p[g[n].colors[t.palette || "primary"].name],
            d = e.isObject(r[o]) ? r[o].hex : r[o];
        return _(d);
      };
      ...
      return E = {
        ...
        configuration: function () {
          return e.extend({}, H, {
            defaultTheme: v,
            alwaysWatchTheme: A,
            registeredStyles: [].concat(H.registeredStyles)
          });
        },
        ...
        link: {
          pre: function (m, i, c) {
            var l = [],
              ...
              $shouldWatch: r.parseAttributeBoolean(i.attr("md-theme-watch")) || t.ALWAYS_WATCH || E && !f
            };
            i.data("$mdThemeController", b);
            ...
            var M = function () {
              ...
              return o(e)(m) || e;
                ...
                g = function (t) {
              return "string" == typeof t ? b.$setTheme(t) : void d.when(e.isFunction(t) ? t() : t).then(function (e) {
                b.$setTheme(e);
              });
            };

            g(M());
            var A = m.$watch(M, function (e) {
              e && (g(e), b.$shouldWatch || A());
            });
          }
        }
      };
    ...
    function m(t, n, o) {
      ...
      var r = [],
          ...
          m = new RegExp("('|\")?{{\\s*(" + n + ")-(color|contrast)-?(\\d\\.?\\d*)?\\s*}}(\"|')?", "g"),
          i = /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow|default)-?(\d\.?\d*)?(contrast)?\s*\}\}'?"?/g,
          c = p[d.name];
      return o = o.replace(i, function (e, n, o, r, d) {
        return "foreground" === n ? "shadow" == o ? t.foregroundShadow : t.foregroundPalette[o] || t.foregroundPalette[1] : (0 !== o.indexOf("hue") && "default" !== o || (o = t.colors[n].hues[o]), u((p[t.colors[n].name][o] || "")[d ? "contrast" : "value"], r));
      }), e.forEach(d.hues, function (e, n) {
        var d = o.replace(m, function (t, n, o, r, d) {
          return u(c[e]["color" === r ? "value" : "contrast"], d);
        });

        if ("default" !== n && (d = d.replace(a, ".md-" + t.name + "-theme.md-" + n)), "default" == t.name) {
          var i = /((?:\s|>|\.|\w|-|:|\(|\)|\[|\]|"|'|=)*)\.md-default-theme((?:\s|>|\.|\w|-|:|\(|\)|\[|\]|"|'|=)*)/g;
          d = d.replace(i, function (e, t, n) {
            return e + ", " + t + n;
          });
        }
    ...
    function i(t, n) {
      function o(t, n) {
        var o = t.contrastDefaultColor,
            r = t.contrastLightColors || [],
            d = t.contrastStrongLightColors || [],
            a = t.contrastDarkColors || [];
        "string" == typeof r && (r = r.split(" ")), "string" == typeof d && (d = d.split(" ")), "string" == typeof a && (a = a.split(" ")), delete t.contrastDefaultColor, delete t.contrastLightColors, delete t.contrastStrongLightColors, delete t.contrastDarkColors, e.forEach(t, function (n, m) {
          function i() {
            return "light" === o ? a.indexOf(m) > -1 ? g : d.indexOf(m) > -1 ? v : A : r.indexOf(m) > -1 ? d.indexOf(m) > -1 ? v : A : g;
          }

          if (!e.isObject(n)) {
            var c = s(n);
            if (!c) throw new Error("Color %1, in palette %2's hue %3, is invalid. Hex or rgb(a) color expected.".replace("%1", n).replace("%2", t.name).replace("%3", m));
            t[m] = {
              hex: t[m],
              value: c,
              contrast: i()
      ...
      var r = document.head,
          d = r ? r.firstElementChild : null,
          a = !H.disableTheming && t.has("$MD_THEME_CSS") ? t.get("$MD_THEME_CSS") : "";
      ...
      if (a += H.registeredStyles.join(""), d && 0 !== a.length) {
        ...
        var m = a.split(/\}(?!(\}|'|"|;))/).filter(function (e) {
          ...
          return e.trim() + "}";
            ...
            i = new RegExp("md-(" + T.join("|") + ")", "g");
        T.forEach(function (e) {
          w[e] = "";
        }), m.forEach(function (e) {
          for (var t, n = (e.match(i), 0); t = T[n]; n++) if (e.indexOf(".md-" + t) > -1) return w[t] += e;

          for (n = 0; t = T[n]; n++) if (e.indexOf(t) > -1) return w[t] += e;

          return w[_] += e;
        }), H.generateOnDemand || e.forEach(n.THEMES, function (e) {
          E[e.name] || "default" !== n.defaultTheme() && "default" === e.name || c(e, e.name, H.nonce);
        });
      }
    }
      ...
      E[t] || (T.forEach(function (t) {
        for (var d = m(e, t, w[t]); d.length;) {
          ...
          if (a) {
            ...
            i.setAttribute("md-theme-style", ""), n && i.setAttribute("nonce", n), i.appendChild(document.createTextNode(a)), o.insertBefore(i, r);
          }
        }
      }), E[e.name] = !0);
    }
    ...
    function s(t) {
      ...
      if ("#" == t.charAt(0) && (t = t.substring(1)), /^([a-fA-F0-9]{3}){1,2}$/g.test(t)) {
        var n = t.length / 3,
            ...
            r = t.substr(n, n),
            d = t.substr(2 * n);
        return 1 === n && (o += o, r += r, d += d), [parseInt(o, 16), parseInt(r, 16), parseInt(d, 16)];
      }
    }
    ...
    t.$inject = ["$mdThemingProvider"], r.$inject = ["$mdTheming", "$interpolate", "$parse", "$mdUtil", "$q", "$log"], a.$inject = ["$mdTheming"], o.$inject = ["$mdColorPalette", "$$mdMetaProvider"], i.$inject = ["$injector", "$mdTheming"], e.module("material.core.theming", ["material.core.theming.palette", "material.core.meta"]).directive("mdTheme", r).directive("mdThemable", a).directive("mdThemesDisabled", d).provider("$mdTheming", o).config(t).run(i);
    var p,
        E = {},
        h = {
      name: "dark",
      ...
      4: "rgba(255,255,255,0.12)"
        ...
        M = "",
        g = s("rgba(0,0,0,0.87)"),
        A = s("rgba(255,255,255,0.87)"),
        v = s("rgb(255,255,255)"),
        T = ["primary", "accent", "warn", "background"],
        _ = "primary",
        N = {
      accent: {
        "default": "A200",
    ...
    var y = ["50", "100", "200", "300", "400", "500", "600", "700", "800", "900", "A100", "A200", "A400", "A700"],
      ...
      nonce: null
        ...
        w = {};
  }(e.angular), t.module("material.core").factory("$$mdAnimate", ["$q", "$timeout", "$mdConstant", "$animateCss", function (e, t, n, o) {
    return function (r) {
      return I(r, e, t, n, o);
    };
    ...
    var n = t.forEach,
        ...
        r = o ? "-webkit-" : "",
        d = (o ? "webkitTransitionEnd " : "") + "transitionend",
      ...
      return r.prototype = {
        ...
        _resolve: function (e) {
          this._state !== m && (n(this._doneCallbacks, function (t) {
            t(e);
          }), this._doneCallbacks.length = 0, this._state = m);
        }
      }, r.all = function (e, t) {
        function o(n) {
          d = d && n, ++r === e.length && t(d);
        }
    ...
    t.module("material.core.animate", []).factory("$$forceReflow", m).factory("$$AnimateRunner", c).factory("$$rAFMutex", i).factory("$animateCss", ["$window", "$$rAF", "$$AnimateRunner", "$$forceReflow", "$$jqLite", "$timeout", "$animate", function (t, m, i, c, l, s, u) {
      function p(o, m) {
        ...
        p && (m.transitionStyle && c.push([r + "transition", m.transitionStyle]), m.keyframeStyle && c.push([r + "animation", m.keyframeStyle]), m.delay && c.push([r + "transition-delay", m.delay + "s"]), m.duration && c.push([r + "transition-duration", m.duration + "s"]), f = m.keyframeStyle || m.to && (m.duration > 0 || m.transitionStyle), _ = !!m.addClass || !!m.removeClass, T(o, !0));
        var N = p && (f || _);
        g(o, m);
        var k,
            y,
        ...
        return {
          ...
          start: function () {
            function t() {
              if (!H) return H = !0, k && y && o.off(k, y), E(o, m), M(o, m), n(c, function (t) {
                l.style[e(t[0])] = "";
              }), u.complete(!0), u;
            }
            ...
            return b(function () {
              ...
              var u = [];
              m.easing && (i.transitionDuration && u.push([r + "transition-timing-function", m.easing]), i.animationDuration && u.push([r + "animation-timing-function", m.easing])), m.delay && i.animationDelay && u.push([r + "animation-delay", m.delay + "s"]), m.duration && i.animationDuration && u.push([r + "animation-duration", m.duration + "s"]), n(u, function (t) {
                var n = t[0],
                    o = t[1];
              ...
              var p = i.delay,
                  ...
                  M = 1e3 * b,
                  g = Date.now();
              k = [], i.transitionDuration && k.push(d), i.animationDuration && k.push(a), k = k.join(" "), y = function (e) {
                e.stopPropagation();
                var n = e.originalEvent || e,
                    o = n.timeStamp || Date.now(),
                    r = parseFloat(n.elapsedTime.toFixed(3));
                Math.max(o - g, 0) >= f && r >= b && t();
              }, o.on(k, y), A(o, m), s(t, f + 1.5 * M, !1);
            }), u;
          }
        };
      }
      ...
      function h(e) {
        ...
        var r = v(e),
            ...
            a = f(d[n("transitionDuration")]),
            m = f(d[n("animationDuration")]),
            i = f(d[n("transitionDelay")]),
            c = f(d[n("animationDelay")]);
        m *= parseInt(d[n("animationIterationCount")], 10) || 1;
        var l = Math.max(m, a),
            s = Math.max(c, i);
        return {
          duration: l,
