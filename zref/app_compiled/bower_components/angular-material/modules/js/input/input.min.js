...
!function (e, n, t) {
  ...
  function i(e, n) {
    function t(n) {
      var t = n[0].querySelector(a),
          i = n[0].querySelector(o);
      return t && n.addClass("md-icon-left"), i && n.addClass("md-icon-right"), function (n, t) {
        e(t);
      };
    }
    ...
    function i(e, t, i, r) {
      var a = this;
      a.isErrorGetter = i.mdIsError && n(i.mdIsError), a.delegateClick = function () {
        a.input.focus();
    ...
    i.$inject = ["$scope", "$element", "$attrs", "$animate"];
  ...
  function a(e, t, i, r, a) {
    function o(o, s, u, l) {
      ...
      function f() {
        function i() {
          ...
          if (!w) {
            ...
            w = s.css("padding", 0).prop("offsetHeight"), s[0].style.padding = n;
          }
        ...
        function m() {
          ...
          if (!u.hasOwnProperty("mdNoResize")) {
            ...
            s.wrap('<div class="md-resize-wrapper">').after(l), l.on("mousedown", e), g.on("$md.dragstart", t).on("$md.drag", i).on("$md.dragend", r), o.$on("$destroy", function () {
              l.off("mousedown", e).remove(), g.off("$md.dragstart", t).off("$md.drag", i).off("$md.dragend", r), v(), l = null, g = null, v = null;
            });
          }
        }

        var f = !u.hasOwnProperty("mdNoAutogrow");
      ...
      var p = l[0],
          ...
          w = s[0].tagName.toLowerCase();

      if (p) {
        if ("hidden" === u.type) return void s.attr("aria-hidden", "true");
        ...
        p.input = s, c();
        var y = n.element('<div class="md-errors-spacer">');
        s.after(y), p.label || i.expect(s, "aria-label", u.placeholder), s.addClass("md-input"), s.attr("id") || s.attr("id", "input_" + e.nextUid()), "input" === w && "number" === u.type && u.min && u.max && !u.step ? s.attr("step", "any") : "textarea" === w && f(), g || m();
  ...
  function s(e) {
    function t(t, i, r, a) {
      if (a) {
        ...
        if (o && o.length || "" === s || t.$eval(s)) return void a.setHasPlaceholder(!0);

        if ("MD-SELECT" != i[0].nodeName) {
          var u = n.element('<label ng-click="delegateClick()" tabindex="-1">' + r.placeholder + "</label>");
          r.$set("placeholder", null), a.element.addClass("md-icon-float").prepend(u), e(u)(t);
        }
      }
    }
  ...
  function u(e) {
    function n(n, t, i) {
      ...
      if ("INPUT" === t[0].nodeName || "TEXTAREA" === t[0].nodeName) {
        var o = !1;
        t.on("focus", r).on("mouseup", a), n.$on("$destroy", function () {
  ...
  function p(e, t) {
    var i,
        ...
        a = C(e),
        o = a.children();
    return 0 == a.length || 0 == o.length ? (b.warn("mdInput messages show animation called on invalid messages element: ", e), void t()) : (n.forEach(o, function (e) {
  ...
  function g(e, t) {
    var i,
        ...
        a = C(e),
        o = a.children();
    return 0 == a.length || 0 == o.length ? (b.warn("mdInput messages hide animation called on invalid messages element: ", e), void t()) : (n.forEach(o, function (e) {
  ...
  function v(n) {
    var t = parseInt(e.getComputedStyle(n[0]).height),
        ...
        a = $(n),
        o = i > -t;
    return o || r.hasClass("md-auto-hide") && !a.hasClass("md-input-invalid") ? E(n, {}) : E(n, {
      event: "enter",
      structural: !0,
      from: {
        opacity: 0,
  ...
  function h(n) {
    var t = n[0].offsetHeight,
        i = e.getComputedStyle(n[0]);
    return 0 === parseInt(i.opacity) ? E(n, {}) : E(n, {
      event: "leave",
      structural: !0,
      from: {
        opacity: 1,
  ...
  i.$inject = ["$mdTheming", "$parse"], a.$inject = ["$mdUtil", "$window", "$mdAria", "$timeout", "$mdGesture"], o.$inject = ["$animate", "$mdUtil"], s.$inject = ["$compile"], d.$inject = ["$mdUtil"], u.$inject = ["$timeout"], c.$inject = ["$$AnimateRunner", "$animateCss", "$mdUtil", "$log"], m.$inject = ["$$AnimateRunner", "$animateCss", "$mdUtil", "$log"], f.$inject = ["$$AnimateRunner", "$animateCss", "$mdUtil", "$log"];
  var y = n.module("material.components.input", ["material.core"]).directive("mdInputContainer", i).directive("label", r).directive("input", a).directive("textarea", a).directive("mdMaxlength", o).directive("placeholder", s).directive("ngMessages", l).directive("ngMessage", d).directive("ngMessageExp", d).directive("mdSelectOnFocus", u).animation(".md-input-invalid", c).animation(".md-input-messages-animation", m).animation(".md-input-message-animation", f);
  e._mdMocksIncluded && y.service("$$mdInput", function () {
    return {
      messages: {
        show: p,
        hide: g,
  ...
  }).service("mdInputInvalidAnimation", c).service("mdInputMessagesAnimation", m).service("mdInputMessageAnimation", f);
  var x,
      E,
      I,
      b,
