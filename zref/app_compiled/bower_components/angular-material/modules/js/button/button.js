...
(function (window, angular, undefined) {
  ...
  function MdButtonDirective($mdButtonInkRipple, $mdTheming, $mdAria, $mdInteraction) {
    ...
    function postLink(scope, element, attr) {
      $mdTheming(element);
      $mdButtonInkRipple.attach(scope, element); // Use async expect to support possible bindings in the button label

      $mdAria.expectWithoutText(element, 'aria-label'); // For anchor elements, we have to set tabindex manually when the
      // element is disabled
