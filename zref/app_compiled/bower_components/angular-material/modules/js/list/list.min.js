      ...
      compile: function (o, s) {
        ...
        function c(n) {
          if ("div" == n) A = t.element('<div class="md-no-style md-list-item-inner">'), A.append(o.contents()), o.addClass("md-proxy-focus");else {
            ...
            f(o[0], r[0]), r.attr("aria-label") || r.attr("aria-label", e.getText(o)), o.hasClass("md-no-focus") && r.addClass("md-no-focus"), A.prepend(r), A.children().eq(1).append(o.contents()), o.addClass("_md-button-wrap");
          }
        ...
        function v(e, o, s, d) {
          ...
          function c() {
            (1 == u.length || v) && (o.addClass("md-clickable"), v || d.attachRipple(e, t.element(o[0].querySelector(".md-no-style"))));
          }
        ...
        var b,
            ...
            A = o;
        if (o[0].setAttribute("role", "listitem"), s.ngClick || s.ngDblclick || s.ngHref || s.href || s.uiSref || s.ngAttrUiSref) c("button");else if (!o.hasClass("md-no-proxy")) {
          for (var k, E = 0; k = a[E]; ++E) if (C = o[0].querySelector(k)) {
            b = !0;
            break;
          }

          b ? c("div") : o.addClass("md-no-proxy");
        }
        return m(), d(), b && "MD-MENU" === C.nodeName && l(), v;
      }
    };
  }
