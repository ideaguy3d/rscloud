...
!function (e, t, a) {
  ...
  t.module("material.components.datepicker", ["material.core", "material.components.icon", "material.components.virtualRepeat"]), function () {
    function e() {
      return {
        template: function (e, t) {
          var a = t.hasOwnProperty("ngIf") ? "" : 'ng-if="calendarCtrl.isInitialized"',
              n = '<div ng-switch="calendarCtrl.currentView" ' + a + '><md-calendar-year ng-switch-when="year"></md-calendar-year><md-calendar-month ng-switch-default></md-calendar-month></div>';
          return n;
        },
        scope: {
          minDate: "=mdMinDate",
    ...
    function a(e, a, n, r, l, s, d, o, c) {
      s(e), this.$element = e, this.$scope = a, this.dateUtil = n, this.$mdUtil = r, this.keyCode = l.KEY_CODE, this.$$rAF = d, this.$mdDateLocale = c, this.today = this.dateUtil.createDateAtMidnight(), this.ngModelCtrl = null, this.SELECTED_DATE_CLASS = "md-calendar-selected-date", this.TODAY_CLASS = "md-calendar-date-today", this.FOCUSED_DATE_CLASS = "md-focus", this.id = i++, this.displayDate = null, this.selectedDate = null, this.firstRenderableDate = null, this.lastRenderableDate = null, this.isInitialized = !1, this.width = 0, this.scrollbarWidth = 0, o.tabindex || e.attr("tabindex", "-1");
      var h,
          u = t.bind(this, this.handleKeyEvent);
      h = e.parent().hasClass("md-datepicker-calendar") ? t.element(document.body) : e, h.on("keydown", u), a.$on("$destroy", function () {
        h.off("keydown", u);
      }), 1 === t.version.major && t.version.minor <= 4 && this.$onInit();
    }

    a.$inject = ["$element", "$scope", "$$mdDateUtil", "$mdUtil", "$mdConstant", "$mdTheming", "$$rAF", "$attrs", "$mdDateLocale"], t.module("material.components.datepicker").directive("mdCalendar", e);
    var n = 340,
        i = 0;
    a.prototype.$onInit = function () {
    ...
    }, a.prototype.configureNgModel = function (e) {
      var t = this;
    ...
    }, a.prototype.setNgModelValue = function (e) {
    ...
    }, a.prototype.setCurrentView = function (e, a) {
      var n = this;
      n.$mdUtil.nextTick(function () {
        n.currentView = e, a && (n.displayDate = t.isDate(a) ? a : new Date(a));
      });
      ...
      if (this.dateUtil.isValidDate(e)) {
        ...
        var a = this.getDateId(e, this.currentView),
    ...
    }, a.prototype.getActionFromKeyEvent = function (e) {
      var t = this.keyCode;
    ...
    }, a.prototype.handleKeyEvent = function (e) {
      var t = this;
    ...
    }, a.prototype.hideVerticalScrollbar = function (e) {
      function t() {
        var t = a.width || n,
            i = a.scrollbarWidth,
            l = e.calendarScroller;
      ...
      a.width > 0 ? t() : a.$$rAF(function () {
        var n = e.calendarScroller;
        a.scrollbarWidth = n.offsetWidth - n.clientWidth, a.width = i.querySelector("table").offsetWidth, t();
      });
    }, a.prototype.getDateId = function (e, t) {
    ...
    function a(e, t, a, n, i, r) {
      this.$element = e, this.$scope = t, this.$animate = a, this.$q = n, this.dateUtil = i, this.dateLocale = r, this.calendarScroller = e[0].querySelector(".md-virtual-repeat-scroller"), this.isInitialized = !1, this.isMonthTransitionInProgress = !1;
      var l = this;
    ...
    a.$inject = ["$element", "$scope", "$animate", "$q", "$$mdDateUtil", "$mdDateLocale"], t.module("material.components.datepicker").directive("mdCalendarMonth", e);
    var n = 265,
        i = 45;
    ...
    }, a.prototype.changeSelectedDate = function (e) {
      var t = this,
          a = t.calendarCtrl,
          n = a.selectedDate;
    ...
    }, a.prototype.changeDisplayDate = function (e) {
    ...
    }, a.prototype.animateDateChange = function (e) {
      if (this.dateUtil.isValidDate(e)) {
    ...
    }, a.prototype.handleKeyEvent = function (e, t) {
    ...
    function e(e, n) {
      var i = e('<md-icon md-svg-src="' + n.mdTabsArrow + '"></md-icon>')({})[0];
      return {
        ...
        link: function (e, a, n, r) {
          var l = r[0],
              s = r[1],
              d = r[2];
          d.calendarCtrl = l, d.monthCtrl = s, d.arrowIcon = i.cloneNode(!0), e.$watch(function () {
            return d.offset;
          }, function (e) {
    ...
    e.$inject = ["$compile", "$$mdSvgRegistry"], a.$inject = ["$element", "$$mdDateUtil", "$mdDateLocale"], t.module("material.components.datepicker").directive("mdCalendarMonthBody", e), a.prototype.generateContent = function () {
    ...
    }, a.prototype.buildDateCell = function (e) {
      ...
      return n;
    }, a.prototype.isDateEnabled = function (e) {
      ...
      var t = this.dateUtil.isValidDate(e) ? e : new Date(),
          ...
          l = 1,
          s = this.buildDateRow(l);
      r.appendChild(s);
      var d = this.offset === this.monthCtrl.items.length - 1,
          o = 0,
      ...
      return r;
    }, a.prototype.getLocaleDay_ = function (e) {
    ...
    function a(e, t, a, n, i) {
      this.$element = e, this.$scope = t, this.$animate = a, this.$q = n, this.dateUtil = i, this.calendarScroller = e[0].querySelector(".md-virtual-repeat-scroller"), this.isInitialized = !1, this.isMonthTransitionInProgress = !1;
      var r = this;
    ...
    a.$inject = ["$element", "$scope", "$animate", "$q", "$$mdDateUtil"], t.module("material.components.datepicker").directive("mdCalendarYear", e);
    var n = 88;
    a.prototype.initialize = function (e) {
      this.items = {
    ...
    }, a.prototype.changeDate = function (e) {
      ...
      if ("select" === t) this.changeDate(n).then(function () {
        ...
        if (i) {
          var l = a.minDate ? r.getFirstDateOfMonth(a.minDate) : null,
              s = a.maxDate ? r.getFirstDateOfMonth(a.maxDate) : null;
      ...
      return {
        ...
        link: function (e, a, n, i) {
          var r = i[0],
              l = i[1],
              s = i[2];
          s.calendarCtrl = r, s.yearCtrl = l, e.$watch(function () {
            return s.offset;
          }, function (e) {
    ...
    a.$inject = ["$element", "$$mdDateUtil", "$mdDateLocale"], t.module("material.components.datepicker").directive("mdCalendarYearBody", e), a.prototype.generateContent = function () {
    ...
    }, a.prototype.buildMonthCell = function (e, t) {
      var a = this.calendarCtrl,
          n = this.yearCtrl,
    ...
    }, a.prototype.buildCalendarForYear = function (e) {
      var t,
          a = e.getFullYear(),
      ...
      t.prototype.$get = function (e, t) {
        function a(e, a) {
          ...
          var n = e.toLocaleTimeString(),
              i = e;
          return 0 !== e.getHours() || n.indexOf("11:") === -1 && n.indexOf("23:") === -1 || (i = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 1, 0, 0)), t("date")(i, "M/d/yyyy", a);
        }
    ...
    t.module("material.components.datepicker").factory("$$mdDateUtil", function () {
      ...
      function o(e, t) {
        return D((e.getTime() + t.getTime()) / 2);
      }
      ...
      function p(e) {
        return new Date(e.getFullYear(), e.getMonth(), a(e));
      }
      ...
      function D(e) {
        var a;
        return a = t.isUndefined(e) ? new Date() : new Date(e), g(a), a;
      }
    ...
    function a(e, a, i, r) {
      return {
        ...
        controllerAs: "ctrl",
        bindToController: !0,
        link: function (e, n, l, o) {
          var c = o[0],
              h = o[1],
              u = o[2],
              m = o[3],
              p = a.parseAttributeBoolean(l.mdNoAsterisk);

          if (h.configureNgModel(c, u, r), u) {
            var f = n[0].querySelector(".md-errors-spacer");
            f && n.after(t.element("<div>").append(f)), u.setHasPlaceholder(l.mdPlaceholder), u.input = n, u.element.addClass(s).toggleClass(d, "calendar" !== l.mdHideIcons && "all" !== l.mdHideIcons), u.label ? p || l.$observe("required", function (e) {
              u.label.toggleClass("md-required", !!e);
            }) : i.expect(n, "aria-label", l.mdPlaceholder), e.$watch(u.isErrorGetter || function () {
              return c.$invalid && (c.$touched || m && m.$submitted);
            }, u.setInvalid);
          } else if (m) var g = e.$watch(function () {
            return m.$submitted;
          }, function (e) {
            e && (h.updateErrorState(), g());
          });
        }
      };
    }
    ...
    n.$inject = ["$scope", "$element", "$attrs", "$window", "$mdConstant", "$mdTheming", "$mdUtil", "$mdDateLocale", "$$mdDateUtil", "$$rAF", "$filter"], a.$inject = ["$$mdSvgRegistry", "$mdUtil", "$mdAria", "inputDirective"], t.module("material.components.datepicker").directive("mdDatepicker", a);
    var i = 3,
    ...
    n.prototype.$onInit = function () {
    ...
    }, n.prototype.configureNgModel = function (e, a, n) {
      this.ngModelCtrl = e, this.mdInputContainer = a, this.$attrs.$set("type", "date"), n[0].link.pre(this.$scope, {
        on: t.noop,
        val: t.noop,
        0: {}
      }, this.$attrs, [e]);
      ...
      i.ngModelCtrl.$formatters.push(function (e) {
        var a = t.isDefined(e) ? Date.parse(e) : null;
        if (!isNaN(a) && t.isNumber(a) && (e = new Date(a)), e && !(e instanceof Date)) throw Error("The ng-model for md-datepicker must be a Date instance or a value that can be parsed into a date. Currently the model is of type: " + typeof e);
      ...
      var a = t.isDefined(this.debounceInterval) ? this.debounceInterval : c;
      ...
      e.ngInputElement.on("keydown", function (t) {
        t.altKey && t.keyCode == n.DOWN_ARROW && (e.openCalendarPane(t), a.$digest());
      }), e.openOnFocus && (e.ngInputElement.on("focus", t.bind(e, e.openCalendarPane)), t.element(e.$window).on("blur", e.windowBlurHandler), a.$on("$destroy", function () {
    ...
    }, n.prototype.updateErrorState = function (e) {
      var a = e || this.date;
      ...
      if (this.clearErrorState(), this.dateUtil.isValidDate(a)) {
        ...
        t.isFunction(this.dateFilter) && this.ngModelCtrl.$setValidity("filtered", this.dateFilter(a));
      ...
      var a = "" == e || this.dateUtil.isValidDate(t) && this.locale.isDateComplete(e) && this.isDateEnabled(t);
      a && (this.setModelValue(t), this.date = t), this.updateErrorState(t);
      ...
      var e = this.calendarPane,
          a = document.body;
      e.style.transform = "", this.$element.addClass(l), this.mdInputContainer && this.mdInputContainer.element.addClass(l), t.element(a).addClass("md-datepicker-is-showing");
      ...
      var r = n.top - i.top - this.topMargin,
      ...
      if (this.inputMask.css({
        ...
        if (m - u > 0) s = m - u;else {
          s = o;
          var p = this.$window.innerWidth / u;
          e.style.transform = "scale(" + p + ")";
        }
        e.classList.add("md-datepicker-pos-adjusted");
      }

      r + h > c && c - h > d && (r = c - h, e.classList.add("md-datepicker-pos-adjusted")), e.style.left = s + "px", e.style.top = r + "px", document.body.appendChild(e), this.$$rAF(function () {
        e.classList.add("md-pane-open");
      });
    }, n.prototype.detachCalendarPane = function () {
      this.$element.removeClass(l), this.mdInputContainer && this.mdInputContainer.element.removeClass(l), t.element(document.body).removeClass("md-datepicker-is-showing"), this.calendarPane.classList.remove("md-pane-open"), this.calendarPane.classList.remove("md-datepicker-pos-adjusted"), this.isCalendarOpen && this.$mdUtil.enableScrolling(), this.calendarPane.parentNode && this.calendarPane.parentNode.removeChild(this.calendarPane);
    }, n.prototype.openCalendarPane = function (t) {
      ...
      if (this.isCalendarOpen) {
        var a = this;
        a.detachCalendarPane(), a.ngModelCtrl.$setTouched(), a.evalAttr("ngBlur"), a.documentElement.off("click touchstart", a.bodyClickHandler), e.removeEventListener(a.windowEventName, a.windowEventHandler), a.calendarPaneOpenedFrom.focus(), a.calendarPaneOpenedFrom = null, a.openOnFocus ? a.$mdUtil.nextTick(t) : t();
      }
