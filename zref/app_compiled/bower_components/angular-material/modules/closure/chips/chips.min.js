...
function MdChip(t, e, i, n) {
  function s(e, s, r, p) {
    var h = p.shift(),
        l = p.shift(),
        d = angular.element(s[0].querySelector(".md-chip-content"));
    t(s), h && (l.init(h), d.append(i(o)(e)), d.on("blur", function () {
      h.resetSelectedChip(), h.$scope.$applyAsync();
    })), n(function () {
      h && h.shouldFocusLastChip && h.focusLastChipThenInput();
    });
  }

  var o = e.processTemplate(DELETE_HINT_TEMPLATE);
  return {
    restrict: "E",
...
function MdChips(t, e, i, n, s, o) {
  function r(r, p) {
    ...
    var a = l("md-chips>md-chip-template"),
        c = e.prefixer().buildList("md-chip-remove").map(function (t) {
      return "md-chips>*[" + t + "]";
    }).join(","),
        C = l(c) || h.remove,
        m = a || h["default"],
        u = l("md-chips>md-autocomplete") || l("md-chips>input") || h.input,
        f = d.find("md-chip");
    return d[0].querySelector("md-chip-template>*[md-chip-remove]") && n.warn("invalid placement of md-chip-remove within md-chip-template."), function (n, r, l, d) {
      ...
      if (a && (c.enableChipEdit = !1), c.chipContentsTemplate = m, c.chipRemoveTemplate = C, c.chipInputTemplate = u, c.mdCloseIcon = o.mdClose, r.attr({
        tabindex: -1
      }).on("focus", function () {
        c.onFocus();
      }), p.ngModel && (c.configureNgModel(r.controller("ngModel")), l.mdTransformChip && c.useTransformChipExpression(), l.mdOnAppend && c.useOnAppendExpression(), l.mdOnAdd && c.useOnAddExpression(), l.mdOnRemove && c.useOnRemoveExpression(), l.mdOnSelect && c.useOnSelectExpression(), u != h.input && n.$watch("$mdChipsCtrl.readonly", function (t) {
        t || e.nextTick(function () {
          if (0 === u.indexOf("<md-autocomplete")) {
            var t = r.find("md-autocomplete");
            c.configureAutocomplete(t.controller("mdAutocomplete"));
          }

          c.configureUserInput(r.find("input"));
        });
      }), e.nextTick(function () {
        var t = r.find("input");
...
MdChipRemove.$inject = ["$timeout"], angular.module("material.components.chips").directive("mdChipRemove", MdChipRemove), MdChipTransclude.$inject = ["$compile"], angular.module("material.components.chips").directive("mdChipTransclude", MdChipTransclude), MdChipsCtrl.$inject = ["$scope", "$attrs", "$mdConstant", "$log", "$element", "$timeout", "$mdUtil"];
var DEFAULT_CHIP_APPEND_DELAY = 300;
angular.module("material.components.chips").controller("MdChipsCtrl", MdChipsCtrl), MdChipsCtrl.prototype.init = function () {
  var t = this;
  t.wrapperId = "_md-chips-wrapper-" + t.$mdUtil.nextUid(), t.$scope.$watchCollection("$mdChipsCtrl.items", function () {
    ...
    t.chipAppendDelay = parseInt(e) || DEFAULT_CHIP_APPEND_DELAY;
  });
...
}, MdChipsCtrl.prototype.inputKeydown = function (t) {
...
}, MdChipsCtrl.prototype.contentIdFor = function (t) {
...
var MD_CHIPS_TEMPLATE = '      <md-chips-wrap          id="{{$mdChipsCtrl.wrapperId}}"          tabindex="{{$mdChipsCtrl.readonly ? 0 : -1}}"          ng-keydown="$mdChipsCtrl.chipKeydown($event)"          ng-class="{ \'md-focused\': $mdChipsCtrl.hasFocus(),                       \'md-readonly\': !$mdChipsCtrl.ngModelCtrl || $mdChipsCtrl.readonly,                      \'md-removable\': $mdChipsCtrl.isRemovable() }"          aria-setsize="{{$mdChipsCtrl.items.length}}"          class="md-chips">        <span ng-if="$mdChipsCtrl.readonly" class="md-visually-hidden">          {{$mdChipsCtrl.containerHint}}        </span>        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{\'md-focused\': $mdChipsCtrl.selectedChip == $index, \'md-readonly\': !$mdChipsCtrl.ngModelCtrl || $mdChipsCtrl.readonly}">          <div class="md-chip-content"              tabindex="{{$mdChipsCtrl.ariaTabIndex == $index ? 0 : -1}}"              id="{{$mdChipsCtrl.contentIdFor($index)}}"              role="option"              aria-selected="{{$mdChipsCtrl.selectedChip == $index}}"               aria-posinset="{{$index}}"              ng-click="!$mdChipsCtrl.readonly && $mdChipsCtrl.focusChip($index)"              ng-focus="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div ng-if="$mdChipsCtrl.isRemovable()"               class="md-chip-remove-container"               tabindex="-1"               md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div class="md-chip-input-container" ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl">          <div md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>',
    CHIP_INPUT_TEMPLATE = '        <input            class="md-input"            tabindex="0"            aria-label="{{$mdChipsCtrl.inputAriaLabel}}"             placeholder="{{$mdChipsCtrl.getPlaceholder()}}"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.onInputFocus()"            ng-blur="$mdChipsCtrl.onInputBlur()"            ng-keydown="$mdChipsCtrl.inputKeydown($event)">',
    CHIP_DEFAULT_TEMPLATE = "      <span>{{$chip}}</span>",
    CHIP_REMOVE_TEMPLATE = '      <button          class="md-chip-remove"          ng-if="$mdChipsCtrl.isRemovable()"          ng-click="$mdChipsCtrl.removeChipAndFocusInput($$replacedScope.$index)"          type="button"          tabindex="-1">        <md-icon md-svg-src="{{ $mdChipsCtrl.mdCloseIcon }}"></md-icon>        <span class="md-visually-hidden">          {{$mdChipsCtrl.deleteButtonLabel}}        </span>      </button>';
