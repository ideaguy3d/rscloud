...
function MenuController(e, t, n, r, o, i, a, l, s) {
  ...
  this.nestLevel = parseInt(t.mdNestLevel, 10) || 0, this.init = function (t, i) {
    ...
    u.attr("id", a), angular.element(d).attr({
      "aria-owns": a,
      "aria-haspopup": "true"
  ...
  this.enableHoverListener = function () {
    ...
    t && t.stopPropagation(), t && t.preventDefault(), m.isOpen || (m.enableHoverListener(), m.isOpen = !0, o.nextTick(function () {
      m.onIsOpenChanged(m.isOpen);
    }), d = d || (t ? t.target : n[0]), d.setAttribute("aria-expanded", "true"), r.$emit("$mdMenuOpen", n), e.show({
      scope: r,
      mdMenuCtrl: m,
    ...
    var e = u[0].querySelector(c.buildSelector(["md-menu-focus-target", "md-autofocus"]));
    e || (e = u[0].querySelector(".md-button:not([disabled])")), e.focus();
    ...
    if (m.isOpen) {
      ...
      var a = angular.extend({}, i, {
        skipFocus: t
      });

      if (r.$emit("$mdMenuClose", n, a), e.hide(null, i), !t) {
        var l = m.restoreFocusTo || n.find("button")[0];
    ...
    open: this.open,
    close: this.close
  }, r.$mdOpenMenu = angular.bind(this, function () {
...
function MenuDirective(e) {
  function t(t) {
    ...
    var o = t.children()[0],
        i = t.children()[1],
        a = e.prefixer();
    a.hasAttribute(o, "ng-click") || (o = o.querySelector(a.buildSelector(["ng-click", "ng-mouseenter"])) || o);
    var l = "MD-BUTTON" === o.nodeName || "BUTTON" === o.nodeName;
    if (o && l && !o.hasAttribute("type") && o.setAttribute("type", "button"), !o) throw Error(r + "Expected the menu to have a trigger element.");
    if (!i || "MD-MENU-CONTENT" !== i.nodeName) throw Error(r + "Expected the menu to contain a `md-menu-content` element.");
    o && o.setAttribute("aria-haspopup", "true");
    var s = t[0].querySelectorAll("md-menu"),
        u = parseInt(t[0].getAttribute("md-nest-level"), 10) || 0;
    return s && angular.forEach(e.nodesToArray(s), function (e) {
      e.hasAttribute("md-position-mode") || e.setAttribute("md-position-mode", "cascade"), e.classList.add("_md-nested-menu"), e.setAttribute("md-nest-level", u + 1);
    }), n;
  }
  ...
  function n(e, t, n, r) {
    ...
    t.addClass("_md"), l.hasAttribute("role") || l.setAttribute("role", "menu"), a.append(l), t.on("$destroy", function () {
      a.remove();
    }), t.append(a), a[0].style.display = "none", o.init(a, {
      isInMenuBar: i
    });
  }
...
function MenuProvider(e) {
  function t(e, t, o, i, a, l, s, u, d, c) {
    function m(t, n, r) {
    ...
    function p(n, r, i) {
      ...
      function g() {
        return i.backdrop ? (i.backdrop.on("click", v), function () {
          i.backdrop.off("click", v);
        }) : angular.noop;
      }
      ...
      function y() {
        function t(t) {
          ...
          switch (t.keyCode) {
            ...
            case o.KEY_CODE.UP_ARROW:
              h(t, i.menuContentEl, i, -1) || i.nestLevel || i.mdMenuCtrl.triggerContainerProxy(t), n = !0;
              break;
        ...
        function r(t) {
          ...
          function o(e, t) {
            ...
            for (var n, r = 0; n = t[r]; ++r) if (b.hasAttribute(e, n)) return !0;
        ...
        if (!i.menuContentEl[0]) return angular.noop;
        i.menuContentEl.on("keydown", t), i.menuContentEl[0].addEventListener("click", r, !0);
        var a = i.menuContentEl[0].querySelector(b.buildSelector(["md-menu-focus-target", "md-autofocus"]));
        if (!a) for (var l = i.menuContentEl[0].children.length, s = 0; s < l; s++) {
          var u = i.menuContentEl[0].children[s];
          if (a = u.querySelector(".md-button:not([disabled])")) break;

          if (u.firstElementChild && !u.firstElementChild.disabled) {
            a = u.firstElementChild;
            break;
          }
        }
        return a && a.focus(), function () {
          i.menuContentEl.off("keydown", t), i.menuContentEl[0].removeEventListener("click", r, !0);
        };
      }

      return f(i), i.menuContentEl[0] ? t.inherit(i.menuContentEl, i.target) : c.warn("$mdMenu: Menu elements should always contain a `md-menu-content` element,otherwise interactivity features will not work properly.", r), i.cleanupResizing = p(), i.hideBackdrop = m(n, r, i), d().then(function (e) {
        return i.alreadyOpen = !0, i.cleanupInteraction = y(), i.cleanupBackdrop = g(), r.addClass("md-clickable"), e;
      });
    }
    ...
    function M(t, n) {
      ...
      var s,
          ...
          h = n.target[0].querySelector(b.buildSelector("md-menu-origin")) || n.target[0],
      ...
      "target" != y.top && "target" != y.left && "target-right" != y.left || (s = l(), s && (s = s.firstElementChild || s, s = s.querySelector(b.buildSelector("md-menu-align-target")) || s, M = s.getBoundingClientRect(), C = {
      ...
      switch (y.top) {
        case "target":
          E.top = C.top + g.top - M.top;
          break;

        case "cascade":
          E.top = g.top - parseFloat(p.paddingTop) - h.style.top;
          break;
      ...
      switch (y.left) {
        case "target":
          E.left = C.left + g.left - M.left, k += O ? "right" : "left";
          break;

        case "target-left":
          E.left = g.left, k += "left";
          break;

        case "target-right":
          E.left = g.right - c.width + (c.right - M.right), k += "right";
          break;

        case "cascade":
          var $ = O ? g.left - c.width < v.left : g.right + c.width < v.right;
          E.left = $ ? g.right - h.style.left : g.left - h.style.left - c.width, k += $ ? "left" : "right";
          break;

        case "right":
          O ? (E.left = g.right - g.width, k += "left") : (E.left = g.right - c.width, k += "right");
          break;

        case "left":
          O ? (E.left = g.right - c.width, k += "right") : (E.left = g.left, k += "left");
          break;
      ...
      var w = n.mdMenuCtrl.offsets();
      E.top += w.top, E.left += w.left, o(E);
      var x = Math.round(100 * Math.min(g.width / u.offsetWidth, 1)) / 100,
          A = Math.round(100 * Math.min(g.height / u.offsetHeight, 1)) / 100;
      return {
        top: Math.round(E.top),
        left: Math.round(E.left),
        transform: n.alreadyOpen ? void 0 : e.supplant("scale({0},{1})", [x, A]),
        transformOrigin: k
      };
    }
