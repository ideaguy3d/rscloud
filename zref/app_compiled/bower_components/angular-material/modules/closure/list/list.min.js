  ...
  return {
    ...
    compile: function (i, o) {
      ...
      function s() {
        ...
        p(r[0]) || r.attr("ng-click", "$mdMenu.open($event)"), r.attr("aria-label") || r.attr("aria-label", "Open List Menu");
      }
      ...
      function d(t) {
        if ("div" == t) y = angular.element('<div class="md-no-style md-list-item-inner">'), y.append(i.contents()), i.addClass("md-proxy-focus");else {
          ...
          var n = angular.element('<md-button class="md-no-style"></md-button>');
          u(i[0], n[0]), n.attr("aria-label") || n.attr("aria-label", e.getText(i)), i.hasClass("md-no-focus") && n.addClass("md-no-focus"), y.prepend(n), y.children().eq(1).append(i.contents()), i.addClass("_md-button-wrap");
        }
      ...
      function m(t, n) {
        if (t && !g(t) && t.hasAttribute("ng-click")) {
          ...
          u(t, r[0], ["ng-if", "ng-hide", "ng-show"]), t.setAttribute("tabindex", "-1"), r.append(t), t = r[0];
        }
      ...
      function h(e, i, o, l) {
        ...
        var m = [],
            ...
            h = g && p(g),
            v = i.hasClass("md-no-proxy");
        s(), d(), m.length && angular.forEach(m, function (t) {
        ...
        h || m.length || g && g.addEventListener("keypress", b), i.off("click"), i.off("keypress"), 1 == m.length && g && i.children().eq(0).on("click", function (e) {
          if (!c(e)) {
            ...
            !t && g.contains(e.target) && angular.forEach(m, function (t) {
      ...
      var v,
          ...
          y = i;
      if (i[0].setAttribute("role", "listitem"), o.ngClick || o.ngDblclick || o.ngHref || o.href || o.uiSref || o.ngAttrUiSref) d("button");else if (!i.hasClass("md-no-proxy")) {
