...
function definePreset(t, e) {
  if (!t || !e) throw new Error("mdPanelProvider: The panel preset definition is malformed. The name and preset object are required.");
  if (_presets.hasOwnProperty(t)) throw new Error("mdPanelProvider: The panel preset you have requested has already been defined.");
  delete e.id, delete e.position, delete e.animation, _presets[t] = e;
}
...
function $getProvider() {
  return ["$rootElement", "$rootScope", "$injector", "$window", function (t, e, n, o) {
    return new MdPanelService(_presets, t, e, n, o);
  }];
}

function MdPanelService(t, e, n, o, i) {
  ...
  }, this._config = {}, this._presets = t, this._$rootElement = e, this._$rootScope = n, this._$injector = o, this._$window = i, this._$mdUtil = this._$injector.get("$mdUtil"), this._trackedPanels = {}, this._groups = Object.create(null), this.animation = MdPanelAnimation.animation, this.xPosition = MdPanelPosition.xPosition, this.yPosition = MdPanelPosition.yPosition, this.interceptorTypes = MdPanelRef.interceptorTypes, this.closeReasons = MdPanelRef.closeReasons, this.absPosition = MdPanelPosition.absPosition;
}
...
function getElement(t) {
  var e = angular.isString(t) ? document.querySelector(t) : t;
...
goog.provide("ngmaterial.components.panel"), goog.require("ngmaterial.components.backdrop"), goog.require("ngmaterial.core"), MdPanelService.$inject = ["presets", "$rootElement", "$rootScope", "$injector", "$window"], angular.module("material.components.panel", ["material.core", "material.components.backdrop"]).provider("$mdPanel", MdPanelProvider);
var MD_PANEL_Z_INDEX = 80,
    ...
    _presets = {};
MdPanelService.prototype.create = function (t, e) {
  if ("string" == typeof t ? t = this._getPresetByName(t) : "object" != typeof t || !angular.isUndefined(e) && e || (e = t, t = {}), t = t || {}, e = e || {}, angular.isDefined(e.id) && this._trackedPanels[e.id]) {
    var n = this._trackedPanels[e.id];
    return angular.extend(n.config, e), n;
  }

  this._config = angular.extend({
    id: e.id || "panel_" + this._$mdUtil.nextUid(),
    scope: this._$rootScope.$new(!0),
    attachTo: this._$rootElement
  }, this._defaultConfigOptions, e, t);
  var o = new MdPanelRef(this._config, this._$injector);
  return this._trackedPanels[e.id] = o, this._config.groupName && (angular.isString(this._config.groupName) && (this._config.groupName = [this._config.groupName]), angular.forEach(this._config.groupName, function (t) {
    o.addToGroup(t);
  })), this._config.scope.$on("$destroy", angular.bind(o, o.detach)), o;
}, MdPanelService.prototype.open = function (t, e) {
  var n = this.create(t, e);
  return n.open().then(function () {
    return n;
  });
}, MdPanelService.prototype._getPresetByName = function (t) {
  ...
  var e = angular.element('<div class="md-panel-outer-wrapper">');
  return t.addClass("md-panel _md-panel-offscreen"), e.append(t), e;
  ...
  return this._$q(function (e, n) {
    ...
    t.attach().then(i).then(s).then(o)["catch"](n);
  });
  ...
  return this._$q(function (n, o) {
    e._callInterceptors(MdPanelRef.interceptorTypes.CLOSE).then(function () {
      var i = e._done(n, e),
          s = e._simpleBind(e.detach, e),
          a = e.config.onCloseSuccess || angular.noop;

      a = angular.bind(e, a, e, t), e.hide().then(s).then(i).then(a)["catch"](o);
    }, o);
  });
  ...
  return this._$q(function (e, n) {
    ...
    t._$q.all([t._createBackdrop(), t._createPanel().then(s)["catch"](n)]).then(i).then(o)["catch"](n);
  });
  ...
  return this._restoreScroll && (this._restoreScroll(), this._restoreScroll = null), this._$q(function (o, i) {
    ...
    t._$q.all([n(), !t._backdropRef || t._backdropRef.detach()]).then(e).then(s)["catch"](i);
  });
}, MdPanelRef.prototype.destroy = function () {
  var t = this;
  this.config.groupName && angular.forEach(this.config.groupName, function (e) {
    t.removeFromGroup(e);
  ...
  return this._$q(function (n, o) {
    var i = t._done(n, t),
        s = t.config.onOpenComplete || angular.noop,
        a = function () {
      t.config.groupName && angular.forEach(t.config.groupName, function (e) {
    ...
    t._$q.all([t._backdropRef ? t._backdropRef.show() : t, e().then(function () {
      t._focusOnOpen();
    }, o)]).then(s).then(a).then(i)["catch"](o);
  });
  ...
  return this._$q(function (e, n) {
    var o = t._done(e, t),
      ...
      if (t.config.groupName) {
        var e;
        angular.forEach(t.config.groupName, function (n) {
      ...
      e && getElement(e).focus();
    };

    t._$q.all([t._backdropRef ? t._backdropRef.hide() : t, t._animateClose().then(i).then(s).then(a).then(r)["catch"](n)]).then(o, n);
  });
  ...
  var t = this;
  return t._$mdCompiler.compile(t.config).then(function (e) {
    var n = t.config;

    if (n.contentElement) {
      var o = e.element;
      t._restoreCache.styles = o[0].style.cssText, t._restoreCache.classes = o[0].className, t.panelContainer = t._$mdPanel._wrapContentElement(o), t.panelEl = o;
    } else t.panelContainer = e.link(n.scope), t.panelEl = angular.element(t.panelContainer[0].querySelector(".md-panel"));

    return t._compilerCleanup = e.cleanup, getElement(t.config.attachTo).append(t.panelContainer), t;
  });
  ...
  return this._$q(function (e, n) {
    t.config.locals || (t.config.locals = {}), t.config.locals.mdPanelRef = t, t._compile().then(function () {
      t.config.disableParentScroll && (t._restoreScroll = t._$mdUtil.disableScrollAround(null, t.panelContainer, {
        disableScrollMask: !0
      })), t.config.panelClass && t.panelEl.addClass(t.config.panelClass), t.config.propagateContainerEvents && t.panelContainer.css("pointer-events", "none"), t._$animate.pin && t._$animate.pin(t.panelContainer, getElement(t.config.attachTo)), t._configureTrapFocus(), t._addStyles().then(function () {
        e(t);
      }, n);
    }, n);
  });
  ...
  return this._$q(function (e) {
    ...
    var n = function () {
      t._setTheming(), t.panelEl.removeClass("_md-panel-offscreen"), t.panelContainer.addClass(MD_PANEL_HIDDEN), e(t);
    };
  ...
  var n = null;
  if (angular.isString(t) ? angular.isFunction(e) || (n = "Interceptor callback must be a function, instead got " + typeof e) : n = "Interceptor type must be a string, instead got " + typeof t, n) throw new Error("MdPanel: " + n);
  var o = this._interceptors[t] = this._interceptors[t] || [];
  ...
  var e = this,
      n = e._$q,
      o = e._interceptors && e._interceptors[t] || [];
  return o.reduceRight(function (t, o) {
  ...
  if (t === MdPanelPosition.absPosition.RIGHT || t === MdPanelPosition.absPosition.LEFT) this._left = this._right = "";else {
    if (t !== MdPanelPosition.absPosition.BOTTOM && t !== MdPanelPosition.absPosition.TOP) {
      var n = Object.keys(MdPanelPosition.absPosition).join().toLowerCase();
  ...
  var e = this._isRTL ? MdPanelPosition.absPosition.RIGHT : MdPanelPosition.absPosition.LEFT;
  return this._setPosition(e, t);
}, MdPanelPosition.prototype.end = function (t) {
  var e = this._isRTL ? MdPanelPosition.absPosition.LEFT : MdPanelPosition.absPosition.RIGHT;
  return this._setPosition(e, t);
  ...
  if (null != t) {
    for (var e, n = Object.keys(MdPanelPosition.yPosition), o = [], i = 0; e = n[i]; i++) {
      var s = MdPanelPosition.yPosition[e];
  ...
  if (null != t) {
    for (var e, n = Object.keys(MdPanelPosition.xPosition), o = [], i = 0; e = n[i]; i++) {
      var s = MdPanelPosition.xPosition[e];
      if (o.push(s), s === t) return;
    }
  ...
  return e.map(function (e) {
    var n = angular.isFunction(e) ? e(this) : e;
    return t + "(" + n + ")";
  }, this).join(" ");
  ...
  switch (this._animationClass) {
    case MdPanelAnimation.animation.SLIDE:
      ...
      var a = e.calculateSlideToOrigin(t, this._openFrom) || "";
      i = e.toTransformCss(a + " " + o);
      break;
    ...
    case MdPanelAnimation.animation.SCALE:
      ...
      var r = e.calculateZoomToOrigin(t, this._openFrom) || "";
      i = e.toTransformCss(r + " " + o);
      break;
    ...
    default:
      n = angular.isString(this._animationClass) ? {
  ...
  return n.duration = this._openDuration, e.translate3d(t, i, s, n);
  ...
  switch (this._animationClass) {
    case MdPanelAnimation.animation.SLIDE:
      ...
      var a = e.calculateSlideToOrigin(t, this._closeTo) || "";
      s = e.toTransformCss(a + " " + o);
      break;
    ...
    case MdPanelAnimation.animation.SCALE:
      ...
      var r = e.calculateZoomToOrigin(t, this._closeTo) || "";
      s = e.toTransformCss(r + " " + o);
      break;
  ...
  return n.duration = this._closeDuration, e.translate3d(t, i, s, n);
  ...
  if (t instanceof angular.element) return {
    element: t,
