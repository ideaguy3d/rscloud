...
function mdIconDirective(e, t, n, i) {
  function o(i, o, a) {
    ...
    var I = (o[0].getAttribute(a.$attr.mdSvgSrc), a.$normalize(a.$attr.mdSvgIcon || a.$attr.mdSvgSrc || ""));
...
function MdIconService(e, t, n, i, o, a) {
  function r(t) {
    if (t = t || "", angular.isString(t) || (t = a.getTrustedUrl(t)), M[t]) return n.when(g(M[t]));
    if (j.test(t) || v.test(t)) return l(t).then(c(t));
  ...
  var M = {},
      x = {},
      j = /[-\w@:%\+.~#?&\/\/=]{2,}\.[a-z]{2,4}\b(\/[-\w@:%\+.~#?&\/\/=]*)?/i,
      v = /^data:image\/svg\+xml[\s*;\w\-\=]*?(base64)?,(.*)$/i;
  return s.prototype = {
    clone: S,
    prepare: f
  }, r.fontSet = u, r;
