...
goog.provide("ngmaterial.components.fabShared"), goog.require("ngmaterial.core"), function () {
  ...
  function n(n, e, t, a, i, o) {
    ...
    function g(n) {
      if (n.target) {
        var e = a.getClosest(n.target, "md-fab-trigger"),
            t = a.getClosest(n.target, "md-fab-actions");
        e || t || D.close();
      }
    }
    ...
    function p(n) {
      switch (n.which) {
        case i.KEY_CODE.ESCAPE:
          return D.close(), n.preventDefault(), !1;
    ...
    function b(n, e) {
      var t = C();
      D.currentActionIndex = D.currentActionIndex + e, D.currentActionIndex = Math.min(t.length - 1, D.currentActionIndex), D.currentActionIndex = Math.max(0, D.currentActionIndex);
      var a = angular.element(t[D.currentActionIndex]).children()[0];
    ...
    function t(n) {
      if (!n.hasClass("md-animations-waiting") || n.hasClass("_md-animations-ready")) {
        var e = n[0],
            ...
            r = parseInt(window.getComputedStyle(o).zIndex);
        angular.forEach(a, function (n, e) {
          ...
          var a,
              ...
              l = (i.clientWidth - n.clientWidth) / 2;
  ...
  var a = 300;
  angular.module("material.components.fabSpeedDial", ["material.core", "material.components.fabShared", "material.components.fabActions"]).directive("mdFabSpeedDial", n).animation(".md-fling", e).animation(".md-scale", t).service("mdFabSpeedDialFlingAnimation", e).service("mdFabSpeedDialScaleAnimation", t);
