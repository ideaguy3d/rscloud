...
goog.provide("ngmaterial.components.datepicker"), goog.require("ngmaterial.components.icon"), goog.require("ngmaterial.components.virtualRepeat"), goog.require("ngmaterial.core"), angular.module("material.components.datepicker", ["material.core", "material.components.icon", "material.components.virtualRepeat"]), function () {
  ...
  function t(e, t, a, i, r, l, s, d, o) {
    ...
    var c,
        h = angular.bind(this, this.handleKeyEvent);
    c = e.parent().hasClass("md-datepicker-calendar") ? angular.element(document.body) : e, c.on("keydown", h), t.$on("$destroy", function () {
      c.off("keydown", h);
    }), 1 === angular.version.major && angular.version.minor <= 4 && this.$onInit();
  }

  t.$inject = ["$element", "$scope", "$$mdDateUtil", "$mdUtil", "$mdConstant", "$mdTheming", "$$rAF", "$attrs", "$mdDateLocale"], angular.module("material.components.datepicker").directive("mdCalendar", e);
  var a = 340,
      n = 0;
  ...
  function e() {
    return {
      template: '<table aria-hidden="true" class="md-calendar-day-header"><thead></thead></table><div class="md-calendar-scroll-mask"><md-virtual-repeat-container class="md-calendar-scroll-container" md-offset-size="' + (n - a) + '"><table role="grid" tabindex="0" class="md-calendar" aria-readonly="true"><tbody md-calendar-month-body role="rowgroup" md-virtual-repeat="i in monthCtrl.items" md-month-offset="$index" class="md-calendar-month" md-start-index="monthCtrl.getSelectedMonthIndex()" md-item-size="' + a + '"><tr aria-hidden="true" style="height:' + a + 'px;"></tr></tbody></table></md-virtual-repeat-container></div>',
  ...
  t.$inject = ["$element", "$scope", "$animate", "$q", "$$mdDateUtil", "$mdDateLocale"], angular.module("material.components.datepicker").directive("mdCalendarMonth", e);
  var a = 265,
      n = 45;
    ...
    return {
      ...
      link: function (e, t, a, i) {
        var r = i[0],
            l = i[1],
            s = i[2];
        s.calendarCtrl = r, s.monthCtrl = l, s.arrowIcon = n.cloneNode(!0), e.$watch(function () {
          return s.offset;
        }, function (e) {
  ...
  function e() {
    return {
      template: '<div class="md-calendar-scroll-mask"><md-virtual-repeat-container class="md-calendar-scroll-container"><table role="grid" tabindex="0" class="md-calendar" aria-readonly="true"><tbody md-calendar-year-body role="rowgroup" md-virtual-repeat="i in yearCtrl.items" md-year-offset="$index" class="md-calendar-year" md-start-index="yearCtrl.getFocusedYearIndex()" md-item-size="' + a + '"><tr aria-hidden="true" style="height:' + a + 'px;"></tr></tbody></table></md-virtual-repeat-container></div>',
  ...
  t.$inject = ["$element", "$scope", "$animate", "$q", "$$mdDateUtil"], angular.module("material.components.datepicker").directive("mdCalendarYear", e);
  var a = 88;
  t.prototype.initialize = function (e) {
    this.items = {
    ...
    return {
      ...
      link: function (e, t, a, n) {
        var i = n[0],
            r = n[1],
            l = n[2];
        l.calendarCtrl = i, l.yearCtrl = r, e.$watch(function () {
          return l.offset;
        }, function (e) {
  ...
  angular.module("material.components.datepicker").config(["$provide", function (e) {
    ...
    t.prototype.$get = function (e, t) {
      ...
      var u = "Calendar",
        ...
        lastRenderableDate: this.lastRenderableDate || g
      };
      return f;
  ...
  angular.module("material.components.datepicker").factory("$$mdDateUtil", function () {
    ...
    function f(e) {
      var t;
      return t = angular.isUndefined(e) ? new Date() : new Date(e), g(t), t;
    }
  ...
  function e(e, a, n, i) {
    return {
      ...
      controllerAs: "ctrl",
      bindToController: !0,
      link: function (e, t, s, d) {
        var o = d[0],
            c = d[1],
            h = d[2],
            u = d[3],
            m = a.parseAttributeBoolean(s.mdNoAsterisk);

        if (c.configureNgModel(o, h, i), h) {
          var p = t[0].querySelector(".md-errors-spacer");
          p && t.after(angular.element("<div>").append(p)), h.setHasPlaceholder(s.mdPlaceholder), h.input = t, h.element.addClass(r).toggleClass(l, "calendar" !== s.mdHideIcons && "all" !== s.mdHideIcons), h.label ? m || s.$observe("required", function (e) {
  ...
  t.$inject = ["$scope", "$element", "$attrs", "$window", "$mdConstant", "$mdTheming", "$mdUtil", "$mdDateLocale", "$$mdDateUtil", "$$rAF", "$filter"], e.$inject = ["$$mdSvgRegistry", "$mdUtil", "$mdAria", "inputDirective"], angular.module("material.components.datepicker").directive("mdDatepicker", e);
  var a = 3,
  ...
  t.prototype.$onInit = function () {
    ...
    this.ngModelCtrl = e, this.mdInputContainer = t, this.$attrs.$set("type", "date"), a[0].link.pre(this.$scope, {
      on: angular.noop,
      val: angular.noop,
      0: {}
    }, this.$attrs, [e]);
    var n = this;
    n.ngModelCtrl.$formatters.push(function (e) {
      var t = angular.isDefined(e) ? Date.parse(e) : null;
      if (!isNaN(t) && angular.isNumber(t) && (e = new Date(t)), e && !(e instanceof Date)) throw Error("The ng-model for md-datepicker must be a Date instance or a value that can be parsed into a date. Currently the model is of type: " + typeof e);
      return n.onExternalChange(e), e;
    }), e.$viewChangeListeners.unshift(angular.bind(this, this.updateErrorState));
    var i = n.$mdUtil.getModelOption(e, "updateOn");
    i && this.ngInputElement.on(i, angular.bind(this.$element, this.$element.triggerHandler, i));
    ...
    angular.element(this.inputContainer).toggleClass(n, !this.ngModelCtrl.$valid);
    ...
    var a = this.inputContainer.getBoundingClientRect(),
    ...
    var r = a.top - n.top - this.topMargin,
