...
function MdSubheaderDirective(e, r, a, i, t) {
  return {
    ...
    link: function (n, d, o, c, m) {
      function s(e) {
        return angular.element(e[0].querySelector(".md-subheader-content"));
      }

      a(d), d.addClass("_md"), i.prefixer().removeAttribute(d, "ng-repeat");
      var u = d[0].outerHTML;
      o.$set("role", "heading"), t.expect(d, "aria-level", "2"), m(n, function (e) {
        s(d).append(e);
      }), d.hasClass("md-no-sticky") || m(n, function (a) {
        var t = r('<div class="md-subheader-wrapper" aria-hidden="true">' + u + "</div>")(n);
        i.nextTick(function () {
          s(t).append(a);
        }), e(n, d, t);
      });
