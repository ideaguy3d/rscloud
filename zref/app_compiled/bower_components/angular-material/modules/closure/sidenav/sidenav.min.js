...
function SidenavService(e, n, t, o) {
  ...
  function i(t, r) {
    var i = e.get(t);
    return i || r ? i : void o.error(n.supplant(l, [t || ""]));
  }
  ...
  return function (e, n) {
    if (angular.isUndefined(e)) return d;
    var t = n === !0,
        o = d.find(e, t);
    return !o && t ? d.waitFor(e) : !o && angular.isUndefined(n) ? r(d, e) : o;
  };
}
  ...
  function p(a, p, f, g) {
    ...
    function $(e) {
      var t = n.findFocusTarget(p) || n.findFocusTarget(p, "[md-sidenav-focus]") || p,
          o = p.parent();
      o[e ? "on" : "off"]("keydown", y), k && k[e ? "on" : "off"]("click", O);
      var l = h(o, e);
      return e && (T = s[0].activeElement, w = r.getLastInteractionType()), C(e), q = c.all([e && k ? i.enter(k, o) : k ? i.leave(k) : c.when(!0), i[e ? "removeClass" : "addClass"](p, "md-closed")]).then(function () {
        a.isOpen && (m(function () {
    ...
    function y(e) {
      var n = e.keyCode === t.KEY_CODE.ESCAPE;
      return n ? O(e) : c.when(!0);
    }
    ...
    f.mdDisableScrollTarget && (F = s[0].querySelector(f.mdDisableScrollTarget), F ? F = angular.element(F) : d.warn(n.supplant('mdSidenav: couldn\'t find element matching selector "{selector}". Falling back to parent.', {
      selector: f.mdDisableScrollTarget
    }))), F || (F = p.parent()), f.hasOwnProperty("mdDisableBackdrop") || (k = n.createBackdrop(a, "md-sidenav-backdrop md-opaque ng-enter")), p.addClass("_md"), o(p), k && o.inherit(k, p), p.on("$destroy", function () {
...
function SidenavController(e, n, t, o, r) {
  ...
  var a = n.mdComponentId,
      ...
      d = l ? r(a)(e.$parent) : a;
  i.destroy = t.register(i, d), l && n.$observe("mdComponentId", function (e) {
