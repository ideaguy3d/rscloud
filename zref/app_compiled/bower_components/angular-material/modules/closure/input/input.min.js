...
function inputTextareaDirective(e, n, t, i, a) {
  function r(r, s, o, u) {
    ...
    function m() {
      function t() {
        ...
        if (!M) {
          ...
          M = s.css("padding", 0).prop("offsetHeight"), s[0].style.padding = n;
        }
      ...
      function c() {
        ...
        if (!o.hasOwnProperty("mdNoResize")) {
          ...
          s.wrap('<div class="md-resize-wrapper">').after(u), u.on("mousedown", e), f.on("$md.dragstart", n).on("$md.drag", t).on("$md.dragend", i), r.$on("$destroy", function () {
    ...
    if (g) {
      ...
      g.input = s, d();
      var C = angular.element('<div class="md-errors-spacer">');
      s.after(C), g.label || t.expect(s, "aria-label", o.placeholder), s.addClass("md-input"), s.attr("id") || s.attr("id", "input_" + e.nextUid()), "input" === M && "number" === o.type && o.min && o.max && !o.step ? s.attr("step", "any") : "textarea" === M && m(), f || c();
...
function mdInputInvalidMessagesAnimation(e, n, t, i) {
  return saveSharedServices(e, n, t, i), {
...
function showInputMessages(e, n) {
  var t,
      ...
      r = a.children();
  return 0 == a.length || 0 == r.length ? ($log.warn("mdInput messages show animation called on invalid messages element: ", e), void n()) : (angular.forEach(r, function (e) {
...
function hideInputMessages(e, n) {
  var t,
      ...
      a = getMessagesElement(e),
      r = a.children();
  return 0 == a.length || 0 == r.length ? ($log.warn("mdInput messages hide animation called on invalid messages element: ", e), void n()) : (angular.forEach(r, function (e) {
...
function hideMessage(e) {
  ...
  return 0 === parseInt(t.opacity) ? $animateCss(e, {}) : $animateCss(e, {
    event: "leave",
    structural: !0,
    from: {
      opacity: 1,
