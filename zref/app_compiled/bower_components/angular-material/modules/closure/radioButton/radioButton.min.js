...
function mdRadioGroupDirective(e, t, n, i) {
  function o(o, r, a, d) {
    ...
    var s = d[0],
        l = d[1] || e.fakeNgModel();
    s.init(l), o.mouseActive = !1, r.attr({
      role: "radiogroup",
    ...
    if (i.count()) {
      var o = function (e) {
        return !angular.element(e).attr("disabled");
          ...
          a = i[n < 0 ? "previous" : "next"](r, o) || i.first();
...
function mdRadioButtonDirective(e, t, n) {
  function i(i, r, a, d) {
    function u() {
      ...
      d.add(s), a.$observe("value", s), r.on("click", c).on("$destroy", function () {
        d.remove(s);
      });
    }
    ...
    function s() {
      ...
      e !== m && ("md-radio-group" !== r[0].parentNode.nodeName.toLowerCase() && r.parent().toggleClass(o, e), e && d.setActiveDescendant(r.attr("id")), m = e, r.attr("aria-checked", e).toggleClass(o, e));
    }
    ...
    var m;
    n(r), l(r, i), a.ngValue ? t.nextTick(u, !1) : u();
  }
