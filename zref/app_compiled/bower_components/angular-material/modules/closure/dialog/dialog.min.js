  ...
  return {
    ...
    link: function (o, a) {
      a.addClass("_md"), t(a), e(function () {
        ...
        var t,
            i = a[0].querySelector("md-dialog-content");
...
function MdDialogProvider(e) {
  ...
  function n(e, t, n, i, r, l, d, c, s, m, u, g, p) {
    ...
    function h(e, t, n, o) {
      if (o) {
        var a = o.htmlContent || n.htmlContent || "",
            i = o.textContent || n.textContent || o.content || n.content || "";
        if (a && !m.has("$sanitize")) throw Error("The ngSanitize module must be loaded in order to use htmlContent.");
        if (a && i) throw Error("md-dialog cannot have both `htmlContent` and `textContent`");
        o.mdHtmlContent = a, o.mdTextContent = i;
      }
    }

    function v(e, t, o, a) {
      function i() {
        t[0].querySelector(".md-actions") && s.warn("Using a class of md-actions is deprecated, please use <md-dialog-actions>.");
      }
      ...
      function r() {
        ...
        if (o.focusOnOpen) {
          var a = n.findFocusTarget(t) || e() || d;
          a.focus();
        }
      }

      angular.element(l[0].body).addClass("md-dialog-is-showing");
      var d = t.find("md-dialog");
      ...
      return $(o), T(d, o), y(e, t, o), k(t, o), x(t, o).then(function () {
        S(t, o), i(), r();
      });
    }
    ...
    function b(e) {
      var t;
      e.targetEvent && e.targetEvent.target && (t = angular.element(e.targetEvent.target));
      var n = t && t.controller("mdTheme");

      if (n) {
        e.themeWatch = n.$shouldWatch;
        var o = e.theme || n.$mdTheme;
        o && (e.scope.theme = o);
        var a = n.registerChanges(function (t) {
    ...
    function $(e) {
        ...
        if (n && n.length) {
          var o = {
            ...
            width: 0
              ...
              a = angular.isFunction(n[0].getBoundingClientRect);
      ...
      e.origin = angular.extend({
        ...
        bounds: null,
        focus: angular.noop
      }, e.origin || {}), e.parent = n(e.parent, c), e.closeTo = t(n(e.closeTo)), e.openFrom = t(n(e.openFrom)), e.targetEvent && (e.origin = t(e.targetEvent.target, e.origin), e.originInteraction = p.getLastInteractionType());
    }
    ...
    function T(e, i) {
      var r = "alert" === i.$type ? "alertdialog" : "dialog",
          ...
          d = e.attr("id"),
          c = "dialogContent_" + (d || n.nextUid());
      e.attr({
        role: r,
        tabIndex: "-1"
      }), 0 === l.length && (l = e, d && (c = d)), l.attr("id", c), e.attr("aria-describedby", c), i.ariaLabel ? t.expect(e, "aria-label", i.ariaLabel) : t.expectAsync(e, "aria-label", function () {
    ...
    function S(e, t) {
      function n(e) {
        for (; e.parentNode;) {
          ...
          for (var t = e.parentNode.children, a = 0; a < t.length; a++) e === t[a] || w(t[a], ["SCRIPT", "STYLE"]) || t[a].setAttribute("aria-hidden", o);
    ...
    function E(e, t) {
      var n = "fixed" == d.getComputedStyle(l[0].body).position,
        ...
        height: e.css("height")
          ...
          r = Math.abs(t.parent[0].getBoundingClientRect().top);
      return e.css({
        top: (n ? r : 0) + "px",
        height: a ? a + "px" : "100%"
      }), function () {
    ...
    function x(e, t) {
      ...
      var o = e.find("md-dialog"),
        ...
        transitionOutClass: "md-transition-out"
          ...
          d = a.toTransformCss("");
      return o.toggleClass("md-dialog-fullscreen", !!t.fullscreen), a.translate3d(o, l, d, r).then(function (e) {
        return t.reverseAnimate = function () {
          ...
          }, l = d, d = a.toTransformCss(i(o, t.closeTo)), a.translate3d(o, l, d, r)) : e(d = a.toTransformCss(i(o, t.origin)));
    ...
    return {
      ...
      transformTemplate: function (e, t) {
        ...
        var o = g.startSymbol(),
            a = g.endSymbol(),
            i = o + (t.themeWatch ? "" : "::") + "theme" + a;
        return '<div class="md-dialog-container" tabindex="-1" md-theme="' + i + '">' + n(e) + "</div>";
      }
    };
  }

  t.$inject = ["$mdDialog", "$mdConstant"], n.$inject = ["$mdDialog", "$mdAria", "$mdUtil", "$mdConstant", "$animate", "$document", "$window", "$rootElement", "$log", "$injector", "$mdTheming", "$interpolate", "$mdInteraction"];
  var o, a;
