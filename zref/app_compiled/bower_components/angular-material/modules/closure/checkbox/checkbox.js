...
function MdCheckboxDirective(inputDirective, $mdAria, $mdConstant, $mdTheming, $mdUtil, $mdInteraction) {
  ...
  function compile(tElement, tAttrs) {
    ...
    function postLink(scope, element, attr, ctrls) {
      ...
      $mdTheming(element); // Redirect focus events to the root element, because IE11 is always focusing the container element instead
      ...
      $mdAria.expectWithText(element, 'aria-label'); // Reuse the original input[type=checkbox] directive from AngularJS core.
