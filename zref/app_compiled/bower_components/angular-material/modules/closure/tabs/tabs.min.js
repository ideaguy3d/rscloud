  ...
  function e(e, n, a, s) {
    if (s) {
      var r = s.getTabElementIndex(n),
          d = t(n, "md-tab-body").remove(),
          i = t(n, "md-tab-label").remove(),
          o = s.insertTab({
        scope: e,
        parent: e.$parent,
        index: r,
...
function MdTabsController(e, t, n, a, s, r, d, i, o, c, l) {
  ...
  function g(e, t) {
    ...
    t && Y(e, t), i.$observe(n, function (t) {
      le[e] = t;
    });
  }
  ...
  function h(e, t) {
    ...
    t && Y(e, t), i.hasOwnProperty(a) && n(i[a]), i.$observe(a, n);
  }

  function T() {
    fe = !0, angular.element(n).off("resize", O);
  }

  function x(e) {
    var t = q();
    angular.element(t.wrapper).toggleClass("md-stretch-tabs", N()), re();
  }

  function v(e) {
    le.shouldCenterTabs = z();
  }
  ...
  function $(e, t) {
    if (e !== t) {
      ...
      }), r.nextTick(le.updateInkBarStyles);
    }
  }

  function C(e, t) {
    e !== t && (le.maxTabWidth = Q(), le.shouldCenterTabs = z(), r.nextTick(function () {
      le.maxTabWidth = Q(), ee(le.selectedIndex);
    }));
  }
  ...
  function k(t, n) {
    t !== n && (le.selectedIndex = K(t), le.lastSelectedIndex = n, le.updateInkBarStyles(), se(), ee(t), e.$broadcast("$mdTabsChanged"), le.tabs[n] && le.tabs[n].scope.deselect(), le.tabs[t] && le.tabs[t].scope.select());
  }
  ...
  function L(e) {
    switch (e.keyCode) {
      ...
      case a.KEY_CODE.ENTER:
        e.preventDefault(), be || P(le.focusIndex);
    }
  }

  function P(e, t) {
    be || (le.focusIndex = le.selectedIndex = e), t && le.noSelectClick || r.nextTick(function () {
      le.tabs[e].element.triggerHandler("click");
    }, !1);
  }

  function W(e) {
    le.shouldPaginate && (e.preventDefault(), le.offsetLeft = ie(le.offsetLeft - e.wheelDelta));
  }
  ...
  function D() {
    ...
    a > t.offsetWidth ? le.offsetLeft = ie(t.offsetLeft) : le.offsetLeft = ie(t.offsetLeft + (t.offsetWidth - a + 1));
  }
  ...
  function A() {
    ...
    n.canvas.clientWidth > t.offsetWidth ? le.offsetLeft = ie(t.offsetLeft + t.offsetWidth - n.canvas.clientWidth) : le.offsetLeft = ie(t.offsetLeft);
  }

  function O() {
    le.lastSelectedIndex = le.selectedIndex, le.offsetLeft = ie(le.offsetLeft), r.nextTick(function () {
      le.updateInkBarStyles(), G();
    });
  }
  ...
  function B(e) {
    if (!fe) {
      ...
      ae(), le.selectedIndex === t && (n.scope.deselect(), le.tabs[le.selectedIndex] && le.tabs[le.selectedIndex].scope.select()), r.nextTick(function () {
        G(), le.offsetLeft = ie(le.offsetLeft);
      });
    }
  }
  ...
  function R(e, t) {
    var n = pe,
      ...
      hasFocus: function () {
        return le.styleTabItemFocus && le.hasFocus && this.getIndex() === le.focusIndex;
      },
      id: r.nextUid(),
      hasContent: !(!e.template || !e.template.trim())
    },
        s = angular.extend(a, e);
    return angular.isDefined(t) ? le.tabs.splice(t, 0, s) : le.tabs.push(s), te(), ne(), r.nextTick(function () {
      G(), ce(s), n && le.autoselect && r.nextTick(function () {
        r.nextTick(function () {
          P(le.tabs.indexOf(s));
        });
      });
  ...
  function N() {
    switch (le.stretchTabs) {
      ...
      default:
        return !le.shouldPaginate && n.matchMedia("(max-width: 600px)").matches;
    }
  }
  ...
  function U() {
    ...
    return angular.forEach(q().dummies, function (t) {
      e -= t.offsetWidth;
    }), e < 0;
  }
  ...
  function G() {
    le.maxTabWidth = Q(), le.shouldPaginate = U();
  }
  ...
  function Z() {
    le.styleTabItemFocus = "keyboard" === l.getLastInteractionType(), q().dummies[le.focusIndex].focus();
  }

  function ee(e) {
    var t = q();

    if (angular.isNumber(e) || (e = le.focusIndex), t.tabs[e] && !le.shouldCenterTabs) {
      var n = t.tabs[e],
          a = n.offsetLeft,
          s = n.offsetWidth + a;
      le.offsetLeft = Math.max(le.offsetLeft, ie(s - t.canvas.clientWidth + 64)), le.offsetLeft = Math.min(le.offsetLeft, ie(a));
    }
  }
  ...
  function ne() {
    for (var e = !1, t = 0; t < le.tabs.length; t++) if (le.tabs[t].hasContent) {
      e = !0;
      break;
    }
  ...
  function ae() {
    le.selectedIndex = K(le.selectedIndex), le.focusIndex = K(le.focusIndex);
  }

  function se() {
    if (!le.dynamicHeight) return t.css("height", "");
    if (!le.tabs.length) return ue.push(se);
    var e = q(),
        n = e.contents[le.selectedIndex],
    ...
    if (o !== i) {
      "bottom" === t.attr("md-align-tabs") && (o -= s, i -= s, void 0 !== t.attr("md-border-bottom") && ++o), be = !0;
      var c = {
        height: o + "px"
      },
          l = {
  ...
  function re() {
    var e = q();
    if (!e.tabs[le.selectedIndex]) return void angular.element(e.inkBar).css({
      left: "auto",
      right: "auto"
    });
    if (!le.tabs.length) return ue.push(le.updateInkBarStyles);
    ...
    de(), angular.element(e.inkBar).css({
      left: d + "px",
      right: i + "px"
    });
  }
  ...
  function de() {
    var e = q(),
        t = le.selectedIndex,
        n = le.lastSelectedIndex,
        a = angular.element(e.inkBar);
  ...
  function oe(e, t) {
    var n = q(),
        a = {
      colorElement: angular.element(n.inkBar)
    };
    s.attach(e, t, a);
  }
  ...
  function ce(e) {
    if (e.hasContent) {
      var n = t[0].querySelectorAll('[md-tab-id="' + e.id + '"]');
      angular.element(n).attr("aria-controls", le.tabContentPrefix + e.id);
    }
  }
  ...
  var le = this,
      ...
      fe = !1,
      pe = !1;
  le.$onInit = b, le.updatePagination = r.debounce(G, 100), le.redirectFocus = Z, le.attachRipple = oe, le.insertTab = R, le.removeTab = B, le.select = P, le.scroll = W, le.nextPage = D, le.previousPage = A, le.keydown = L, le.canPageForward = _, le.canPageBack = H, le.refreshIndex = ae, le.incrementIndex = X, le.getTabElementIndex = S, le.updateInkBarStyles = r.debounce(re, 100), le.updateTabOrder = r.debounce(V, 100), le.getFocusedTabId = j, 1 === angular.version.major && angular.version.minor <= 4 && this.$onInit();
}
    ...
    link: function (n, a, s, r) {
      if (r) {
        ...
        if ("MutationObserver" in t) {
          ...
          d = new MutationObserver(o), d.observe(a[0], c), i = d.disconnect.bind(d);
        } else {
          var l = e.debounce(o, 15, null, !1);
          a.on("DOMSubtreeModified", l), i = a.off.bind(a, "DOMSubtreeModified", l);
        }
