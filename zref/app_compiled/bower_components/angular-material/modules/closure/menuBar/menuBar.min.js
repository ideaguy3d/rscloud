...
function MenuBarController(e, n, t, o, r, i, a, l) {
  this.$element = t, this.$attrs = o, this.$mdConstant = r, this.$mdUtil = a, this.$document = i, this.$scope = e, this.$rootScope = n, this.$timeout = l;
  var u = this;
    ...
    compile: function (t, o) {
      return o.ariaRole || t[0].setAttribute("role", "menubar"), angular.forEach(t[0].children, function (n) {
        if ("MD-MENU" == n.nodeName) {
          ...
          var t = e.nodesToArray(n.querySelectorAll("md-menu-content"));
...
function MenuItemDirective(e, n, t) {
  return {
    ...
    compile: function (n, o) {
      ...
      function i(t) {
        ...
        angular.forEach(o, function (e) {
          if (n[0].hasAttribute(e)) {
            ...
            s[0].setAttribute(e, t), n[0].removeAttribute(e);
          }
        });
      }
      ...
      var a = o.type,
          l = "md-in-menu-bar";
      if ("checkbox" != a && "radio" != a || !n.hasClass(l)) r("role", "menuitem", n[0].querySelector("md-button, button, a"));else {
        var u = n[0].textContent,
            s = angular.element('<md-button type="button"></md-button>'),
            c = '<md-icon md-svg-src="' + t.mdChecked + '"></md-icon>';
        s.html(u), s.attr("tabindex", "0"), n.html(""), n.append(angular.element(c)), n.append(s), n.addClass("md-indent").removeClass(l), r("role", "checkbox" == a ? "menuitemcheckbox" : "menuitemradio", s), i("ng-disabled");
      }
...
MenuBarController.prototype.init = function () {
  var e = this.$element,
      ...
      o = this,
      r = [];
  e.on("keydown", this.handleKeyDown), this.parentToolbar = n.getClosest(e, "MD-TOOLBAR"), r.push(this.$rootScope.$on("$mdMenuOpen", function (n, t) {
    ...
    if (a.indexOf(r[0]) != -1 && (e[0].classList.remove("md-open"), r[0].classList.remove("md-open")), e[0].contains(r[0])) {
      for (var l = r[0]; l && a.indexOf(l) == -1;) l = n.getClosest(l, "MD-MENU", !0);
    ...
    for (o.disableOpenOnHover(); r.length;) r.shift()();
  ...
  var n = angular.element(e.currentTarget),
      t = n.controller("mdMenu");
  this.setKeyboardMode(!1), this.scheduleOpenMenu(t);
}, MenuBarController.prototype.scheduleOpenMenu = function (e) {
  var n = this,
      t = this.$timeout;
  e != n.currentlyOpenMenu && (t.cancel(n.pendingMenuOpen), n.pendingMenuOpen = t(function () {
    n.pendingMenuOpen = void 0, n.currentlyOpenMenu && n.currentlyOpenMenu.close(!0, {
      closeAll: !0
    }), e.open();
  }, 200, !1));
  ...
  switch (e.keyCode) {
    case n.DOWN_ARROW:
      t ? t.focusMenuContainer() : this.openFocusedMenu(), r = !0;
      break;
  ...
  var n = this.getMenus(),
      t = this.getFocusedMenuIndex();
  t == -1 && (t = this.getOpenMenuIndex());
  var o = !1;
  if (t == -1 ? (t = 0, o = !0) : (e < 0 && t > 0 || e > 0 && t < n.length - e) && (t += e, o = !0), o) return n[t].querySelector("button").focus(), n[t];
  ...
  var e = this.$mdUtil,
      n = e.getClosest(this.$document[0].activeElement, "MD-MENU");
  if (!n) return -1;
  var t = this.getMenus().indexOf(n);
  return t;
}, MenuBarController.prototype.getOpenMenuIndex = function () {
  for (var e = this.getMenus(), n = 0; n < e.length; ++n) if (e[n].classList.contains("md-open")) return n;

  return -1;
}, MenuBarController.prototype.handleParentClick = function (e) {
  var n = this.querySelector("md-menu.md-open");
  n && !n.contains(e.target) && angular.element(n).controller("mdMenu").close(!0, {
    closeAll: !0
  });
  ...
  var n = this.$element,
      t = this.$attrs;
  this.ngModel = e, "checkbox" != t.type && "radio" != t.type || (this.mode = t.type, this.iconEl = n[0].children[0], this.buttonEl = n[0].children[1], e && this.initClickListeners());
  ...
  var n,
      ...
      o = this.ngModel,
      r = this.$attrs;
  "checkbox" == t ? n = !o.$modelValue : "radio" == t && (n = r.ngValue ? this.$scope.$eval(r.ngValue) : r.value), o.$setViewValue(n), o.$render();
