...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('angular')) : typeof define === 'function' && define.amd ? define(['exports', 'angular'], factory) : factory(global['@uirouter/angularjs-state-events'] = global['@uirouter/angularjs-state-events'] || {}, global.angular);
  ...
  (function () {
    ...
    function $StateEventsProvider($stateProvider) {
      ...
      function $get($transitions) {
        ...
        if (enabledStateEvents.$stateChangeStart) $transitions.onBefore({}, stateChangeStartHandler, {
          priority: 1000
        });
        return {
    ...
    ng.module('ui.router.state.events', ['ui.router.state']).provider("$stateEvents", $StateEventsProvider).run(['$stateEvents', function ($stateEvents) {}]);
  })();
