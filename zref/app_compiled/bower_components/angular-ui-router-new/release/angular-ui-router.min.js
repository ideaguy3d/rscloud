 ...
 */
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? e(exports, require("angular")) : "function" == typeof define && define.amd ? define(["exports", "angular"], e) : e(t["@uirouter/angularjs"] = t["@uirouter/angularjs"] || {}, t.angular);
}(void 0, function (t, e) {
  "use strict";
  ...
  function x(t) {
    for (var e = 1; e < arguments.length; e++) {
      var r = arguments[e];
      if (r) for (var n = Object.keys(r), i = 0; i < n.length; i++) {
        t[n[i]] = r[n[i]];
      }
    }
  ...
  function j(t, e) {
    ...
    if (r !== _typeof(e) || "object" !== r) return !1;
    var n = [t, e];
  ...
  function nt(t) {
    var e = function e(t) {
      ...
      return new ir(t.token, t.val, e(t.val), t.policy);
        ...
        l = s([[Nt(ir), function (t) {
      return t;
    }], [r, u], [n, u], [o, c], [Ut(!0), function (t) {
  ...
  var Bt = Object.prototype.toString,
    ...
    return Object.keys(t).map(function (e) {
      ...
      Ie = function Ie(t, e) {
    return void 0 === e && (e = Ut(!0)), function (r, n) {
  ...
  var tr = function () {
    ...
    return t.prototype.applyRawParams = function (t) {
      var e = function e(_e4) {
        return [_e4.id, _e4.value(t[_e4.id])];
      };
  ...
  var nr = {
    ...
    function t(e, r, n, i, o) {
      if (this.resolved = !1, this.promise = void 0, e instanceof t) pe(this, e);else if (Kt(r)) {
  ...
  var or = {
    ...
    return e.prototype.onBefore = function (t, e, r) {}, e.prototype.onStart = function (t, e, r) {}, e.prototype.onExit = function (t, e, r) {}, e.prototype.onRetain = function (t, e, r) {}, e.prototype.onEnter = function (t, e, r) {}, e.prototype.onFinish = function (t, e, r) {}, e.prototype.onSuccess = function (t, e, r) {}, e.prototype.onError = function (t, e, r) {}, e.prototype.createTransitionHookRegFns = function () {
      ...
      var t = this.router.globals.transition,
          ...
          r = function r(t, _r2) {
        if (t.length !== _r2.length) return !1;
        var n = rr.matching(t, _r2);
  ...
  var dr = null,
    ...
    return (dr = dr || s([[Ht(zt), Ut("undefined")], [Jt, Ut("null")], [ie, Ut("[Promise]")], [e, function (t) {
      return t._transitionRejection.toString();
    }], [Nt(Ne), u("toString")], [Nt(pr), u("toString")], [Nt(ir), u("toString")], [c, z], [Ut(!0), f]]))(t);
  },
      mr = function mr(t) {
    return function (e) {
      if (!e) return ["", ""];
  ...
  var gr = function () {
    ...
    return t.prototype.$inherit = function (t, e, r) {
      ...
      for (var u in i) {
        if (i[u] && i[u].params && (n = Object.keys(i[u].params), n.length)) for (var s in n) {
    ...
    return function (r) {
      ...
      var i = wr(n.url),
          ...
          a = i ? t.compile(i.val, {
        params: r.params || {},
        paramMap: function paramMap(t, e) {
    ...
    return function (e) {
      var r = function r(e, _r3) {
        return t.fromConfig(_r3, null, e);
      },
    ...
    return t.prototype.dispose = function () {
      ...
      for (var t = this, e = this, r = e.queue, n = e.states, i = e.builder, o = [], a = [], u = {}, s = function s(e) {
    ...
    function e(t, r, n, i) {
      ...
      for (var a, u, s, c = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, l = /([:]?)([\w\[\].-]+)|\{([\w\[\].-]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, h = 0, p = [], d = function d(r) {
      ...
      }; (a = c.exec(t)) && (u = v(a, !1), !(u.segment.indexOf("?") >= 0));) {
        d(u.id), this._params.push(n.fromPath(u.id, u.type, this.config.paramMap(u.cfg, !1))), this._segments.push(u.segment), p.push([u.segment, P(this._params)]), h = c.lastIndex;
      }
      ...
      if (y >= 0) {
        var g = s.substring(y);
        if (s = s.substring(0, y), g.length > 0) for (h = 0; a = l.exec(g);) {
          u = v(a, !0), d(u.id), this._params.push(n.fromSearch(u.id, u.type, this.config.paramMap(u.cfg, !0))), h = c.lastIndex;
        }
      }
    ...
    return e.prototype.append = function (t) {
      ...
      for (var l = 0; l < c; l++) {
        for (var h = u[l], p = o[l + 1], d = 0; d < h.replace.length; d++) {
          h.replace[d].from === p && (p = h.replace[d].to);
        }
      ...
      var e = function e(t, _e6) {
        return !t || t.validates(_e6);
      };
  ...
  var Or = function () {
    function e() {
      ...
      this.paramTypes = new yr(), this._isCaseInsensitive = !1, this._isStrictMode = !0, this._defaultSquashPolicy = !1, this._getConfig = function (t) {
        ...
        fromConfig: function fromConfig(r, n, i) {
          return new tr(r, n, i, t.DefType.CONFIG, e);
        },
        fromPath: function fromPath(r, n, i) {
          return new tr(r, n, i, t.DefType.PATH, e);
        },
        fromSearch: function fromSearch(r, n, i) {
    ...
    return t.prototype.compile = function (t) {
      ...
      var i = e;
      Zt(e) && (e = this.router.urlMatcherFactory.compile(e)), Nt(kr)(e) && (i = function i(t) {
        return e.format(t);
      });
      var o = {
        urlMatcher: t,
      ...
      var r = function r(_r4) {
        var n = e.stateService,
            i = e.globals;
        n.href(t, _r4) !== n.href(i.current, i.params) && n.transitionTo(t, _r4, {
          inherit: !0,
          source: "url"
        });
      },
  ...
  var Ar = function () {
    ...
    return t.prototype._rootViewContext = function (t) {
      ...
      var i = this,
        ...
        var e = t[0],
            r = t[1];
        -1 !== i._uiViews.indexOf(e) && e.configUpdated(r);
      };
      ...
      return e.filter(r).length && Ge.traceViewServiceUIViewEvent("!!!! duplicate uiView named:", t), e.push(t), this.sync(), function () {
  ...
  wi = ["$view", "$animate", "$uiViewScroll", "$interpolate", "$q", function (t, e, r, n, i) {
    ...
    var u = {
      ...
      priority: 400,
      transclude: "element",
      compile: function compile(e, c, f) {
