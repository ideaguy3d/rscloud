...
(function (global, factory) {
...
})(void 0, function (exports, _uirouter_core, angular) {
  'use strict';
  /** @module ng1 */
  ...
  var $resolve = {
    ...
    * ### Not bundled by default
     ...
     */
    resolve: function resolve(invocables, locals, parent) {
      if (locals === void 0) {
        locals = {};
      }

      var parentNode = new _uirouter_core.PathNode(new _uirouter_core.StateObject({
        params: {},
        resolvables: []
      }));
      var node = new _uirouter_core.PathNode(new _uirouter_core.StateObject({
        params: {},
        resolvables: []
      }));
      var context = new _uirouter_core.ResolveContext([parentNode, node]);
      context.addResolvables(_uirouter_core.resolvablesBuilder({
        resolve: invocables
      }), node.state);

      var resolveData = function resolveData(parentLocals) {
        var rewrap = function rewrap(_locals) {
          return _uirouter_core.resolvablesBuilder({
            resolve: _uirouter_core.mapObj(_locals, function (local) {
              return function () {
                return local;
              };
            })
        ...
        var tuples2ObjR = function tuples2ObjR(acc, tuple) {
  ...
  var resolveFactory = function resolveFactory() {
    return $resolve;
