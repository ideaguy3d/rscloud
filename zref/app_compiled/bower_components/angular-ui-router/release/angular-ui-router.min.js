...
"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "ui.router"), function (a, b, c) {
  ...
  function z(a, c, d, e, f) {
    ...
    var i = g(),
      ...
      priority: 400,
      transclude: "element",
      compile: function compile(c, g, i) {
  ...
  s.prototype.concat = function (a, b) {
    ...
    for (f = 0; f < i; f++) {
      ...
      if (k) {
        var s = c[f + 1],
            t = f + 1 === h;
        if (q === !1) null != r && (j += Q(r) ? o(r, b).join("-") : encodeURIComponent(r)), j += s;else if (q === !0) {
          var u = j.match(/\/$/) ? /\/?(.*)/ : /(.*)/;
          j += s.match(u)[1];
        } else O(q) && (j += q + s);
