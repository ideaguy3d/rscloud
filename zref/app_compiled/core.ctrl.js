...
(function () {
  ...
  angular.module('rsCloudApp').controller('CoreCtrl', ['$rootScope', '$scope', '$mdSidenav', '$mdDialog', '$timeout', '$location', 'rsAuth', CoreClass]);

  function CoreClass($rootScope, $scope, $mdSidenav, $mdDialog, $timeout, $location, rsAuth) {
    $scope.ccCurrentUser = "";
