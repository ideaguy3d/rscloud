...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'assets/vendor/angularfire/dist/angularfire.js',
      'assets/vendor/angular-md5/angular-md5.js',
      'assets/vendor/angular-animate/angular-animate.js',
      'assets/vendor/angular-aria/angular-aria.js',
      'assets/vendor/angular-messages/angular-messages.js',
      'assets/vendor/angular-material/angular-material.js',
      'assets/vendor/angular-material-icons/angular-material-icons.min.js',
      'assets/vendor/angular-route/angular-route.js',
      'assets/vendor/ngSmoothScroll/lib/angular-smooth-scroll.js',
