...
(function () {
  ...
  angular.module('rsCloudApp').controller('CoreCtrl', ['$rootScope', '$scope', '$mdSidenav', '$mdDialog', '$timeout', '$location', CoreClass]);

  function CoreClass($rootScope, $scope, $mdSidenav, $mdDialog, $timeout, $location) {
    $scope.ccCurrentUser = "";
